...
All transactions and gameplay actions in Eternum are **final** and ALL $LORDS tokens and in-game resources are
**permanently** locked within the game. There are no mechanisms for refunds, reversals, or compensation. You acknowledge
the **risk of loss of funds** and accept that you bear sole responsibility for any financial impact incurred.
