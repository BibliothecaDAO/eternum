...
depletes food supplies from their realm. Unexplored hexes require 20 stamina to explore. Explored hexes require 10
...
resources. Maintaining a balanced production is key to sustaining your realm's economy. If there are insufficient
resources or storage capacity, production automatically stops, but input resources continue to be consumed until paused.
