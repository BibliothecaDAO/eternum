...
Hyperstructures are massive social engineering projects. <img src="/buildings/hyperstructure.png" alt="Hyperstructure" width="200" className="relative z-[100000] float-right" />
