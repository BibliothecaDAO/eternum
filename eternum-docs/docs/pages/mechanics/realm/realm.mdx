...
requires various resources. The costs of upgrading your realms is as follows:

- **Settlement**: Your starting realm. A small settlement with 6 buildable hexes.
...
> will help you learn the game and reward you with starting resources. Claim your resources when you complete each
> quest.
