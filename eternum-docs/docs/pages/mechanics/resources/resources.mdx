...
import RarityResourceTable from "../../../../src/components/RarityResourceTable";
import TroopsTable from "../../../../src/components/TroopsTable";

# Resources

Resources are the foundation of **Eternum**'s economy. Each of the 22 resources play a vital role in the game's
