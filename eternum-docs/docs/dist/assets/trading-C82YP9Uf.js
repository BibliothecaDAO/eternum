import{d as t,j as e}from"./index-CQt94Hr5.js";const s={title:"Trading",description:"Trading mechanics and marketplace system in Eternum"};function i(r){const n={a:"a",blockquote:"blockquote",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"trading-system",children:["Trading System",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#trading-system",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
its fees.`}),`
`,e.jsx(n.p,{children:"Anyone can claim it for himself, but be wary, as it is protected by a significant defensive force."}),`
...
`]}),`
`]})]})}function d(r={}){const{wrapper:n}={...t(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(i,{...r})}):i(r)}export{d as default,s as frontmatter};
