import{j as s,d as x}from"./index-BFDTgyWJ.js";import{g as c,S as u,K as r,a}from"./index-CDgD-HsN.js";import{R as o}from"./ResourceIcon-DmQfGj87.js";function d({buildingType:l}){const n=c.buildings.buildingCosts[l],j=c.resources.resourceBuildingCosts[u.Wood],g=c.resources.resourceBuildingCosts[u.Stone],t=e=>e<1e3?`${e}K`:`${Math.floor(e/1e3)}M`;return l===r.Resource?s.jsxs("div",{className:"my-4 p-3 ",children:[s.jsx("div",{className:"font-bold mb-2",children:"Building costs:"}),s.jsxs("div",{className:"flex flex-row items-center gap-4",children:[j.map(e=>{const i=a(e.resource);return s.jsxs("div",{className:"flex items-center gap-1 px-2 py-1.5 rounded-md",children:[s.jsx(o,{size:24,id:e.resource,name:(i==null?void 0:i.trait)||""}),s.jsx("span",{className:"font-medium",children:t(e.amount)})]},e.resource)}),s.jsx("span",{className:"",children:"or"}),g.map(e=>{const i=a(e.resource);return s.jsxs("div",{className:"flex items-center gap-1 px-2 py-1.5 rounded-md",children:[s.jsx(o,{size:24,id:e.resource,name:(i==null?void 0:i.trait)||""}),s.jsx("span",{className:"font-medium",children:t(e.amount)})]},e.resource)})]})]}):n.length===0?null:s.jsxs("div",{className:"my-4 p-3 ",children:[s.jsx("div",{className:"font-bold mb-2",children:"Building costs:"}),s.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 gap-2",children:n.map(e=>{const i=a(e.resource);return s.jsxs("div",{className:"flex items-center gap-1 px-2 py-1.5 rounded-md",children:[s.jsx(o,{size:24,id:e.resource,name:(i==null?void 0:i.trait)||""}),s.jsx("span",{className:"font-medium",children:t(e.amount)})]},e.resource)})})]})}const f={title:"Buildings",description:"undefined"};function h(l){const n={a:"a",blockquote:"blockquote",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...x(),...l.components};return s.jsxs(s.Fragment,{children:[s.jsx(n.header,{children:s.jsxs(n.h1,{id:"buildings",children:["Buildings",s.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#buildings",children:s.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,s.jsxs(n.p,{children:[s.jsx(n.strong,{children:"Worker Hut"})," ",s.jsx("img",{src:"/buildings/workers_hut.png",alt:"Worker Hut",width:"300",className:"float-right"})]}),`
...
`]}),`
`]})]})}function y(l={}){const{wrapper:n}={...x(),...l.components};return n?s.jsx(n,{...l,children:s.jsx(h,{...l})}):h(l)}export{y as default,f as frontmatter};
