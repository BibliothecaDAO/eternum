import{d as a,j as e}from"./index-BFDTgyWJ.js";const s={title:"Trading",description:"Trading mechanics and marketplace system in Eternum"};function r(t){const n={a:"a",blockquote:"blockquote",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"-trading-system",children:["🫏 Trading System",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#-trading-system",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(n.p,{children:"The AMM enables players to swap resources for $LORDS and vice versa. Exchange rates are influenced by liquidity pools."}),`
...
`,e.jsx(n.p,{children:`Players can provide liquidity by depositing resources and $LORDS into pools. This earns trading fees proportional to
...
`,e.jsx(n.p,{children:`Donkeys are essential for all resource transfers. Each donkey can carry up to 100kg, and transport time depends on the
distance to its destination. It's important to consider transport costs in your trade calculations.`}),`
`,e.jsxs(n.h3,{id:"transport-time-calculation",children:["Transport Time Calculation",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#transport-time-calculation",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
`,e.jsx(n.p,{children:"The transport time depends on the distance and is calculated based on the donkey's speed of 24 seconds per kilometer."}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Owner collect AMM trading fees, providing a significant source of passive income."}),`
...
`]}),`
`]})]})}function d(t={}){const{wrapper:n}={...a(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{d as default,s as frontmatter};
