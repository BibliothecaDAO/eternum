import{d as s,j as e}from"./index-Ca64bMZ6.js";import{g as r}from"./index-CwGDmRQ0.js";const l=void 0;function a(i){const n={a:"a",blockquote:"blockquote",div:"div",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.h2,{id:"combat-system",children:["Combat System",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#combat-system",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(n.h3,{id:"unit-advantages",children:["Unit Advantages",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#unit-advantages",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
`,e.jsxs(n.blockquote,{children:[`
`,e.jsxs(n.p,{children:["When attacking a realm, combat begins with an ",r.battle.delaySeconds/3600," hour siege phase."]}),`
`,e.jsx(n.p,{children:"During this time, defenders can:"}),`
`,e.jsxs(n.ul,{children:[`
...
`]})]})}function c(i={}){const{wrapper:n}={...s(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(a,{...i})}):a(i)}export{c as default,l as frontmatter};
