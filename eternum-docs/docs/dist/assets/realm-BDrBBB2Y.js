import{j as e,d as h}from"./index-Dw30BblS.js";import{U as j,H as m,p as t,w as p,t as l,V as g}from"./index-Uy6IXIoV.js";import{f as c,d as f}from"./formatting-Br5KoSdE.js";import{R as u}from"./ResourceIcon-DPCSwPKc.js";function d({level:s}){const n=j[s];return n.length===0?null:e.jsxs("div",{className:"my-4 p-3",children:[e.jsx("div",{className:"font-bold mb-2",children:"Upgrade costs:"}),e.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 gap-2",children:n.map(i=>{const r=m(i.resource);return e.jsxs("div",{className:"flex items-center gap-2 px-3 py-1.5",children:[e.jsx(u,{size:24,id:i.resource,name:(r==null?void 0:r.trait)||""}),e.jsxs("span",{className:"font-medium",children:[c(i.amount),"K"]})]},i.resource)})})]})}function v(s){return s.replace(/([A-Z])/g," $1").trim()}function b(){return e.jsx(e.Fragment,{children:Object.entries(t.questResources).map(([s,n],i)=>e.jsxs("div",{className:"my-4 p-3 ",children:[e.jsx("div",{className:"font-bold mb-2",children:v(p[Number(s)])}),e.jsx("div",{className:"grid grid-cols-6 gap-2",children:n.map((r,x)=>{const a=m(r.resource);return e.jsxs("div",{className:"flex items-center gap-1 px-2 py-1.5 rounded-md",children:[e.jsx(u,{size:24,id:r.resource,name:(a==null?void 0:a.trait)||""}),e.jsxs("span",{className:"font-medium",children:[c(r.amount),"K"]})]},x)})})]},i))})}const N={title:"Realms",description:"undefined"};function o(s){const n={a:"a",blockquote:"blockquote",div:"div",em:"em",h1:"h1",h2:"h2",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...h(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"realms",children:["Realms",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#realms",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[t.tick.armiesTickIntervalInSeconds/3600*t.battle.graceTickCount,`-hour
