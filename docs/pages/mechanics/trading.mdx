...
title: Trading description: Trading mechanics and marketplace system in Eternum
...
Donkeys are essential for all resource transfers. Each donkey can carry up to 4000kg, and transport time depends on the
...
- **Withdrawing Resources**: To bridge resources out of the game, you must first travel from your realm to the central
  bank. This process is not instant, resources must physically "move" to the bank. You can bridge out here <a href="https://empire.realms.world/">here</a>.
