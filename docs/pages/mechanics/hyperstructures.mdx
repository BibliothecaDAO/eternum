...
Eternum is achieved by accumulating **{formatNumberWithCommas(HYPERSTRUCTURE_POINTS_FOR_WIN)}** Victory Points. View and
...
{formatNumberWithCommas(EternumGlobalConfig.hyperstructures.hyperstructurePointsOnCompletion)} Victory Points, divided
...
- **{EternumGlobalConfig.hyperstructures.hyperstructurePointsPerCycle} Victory Points** are generated each Eternum day
