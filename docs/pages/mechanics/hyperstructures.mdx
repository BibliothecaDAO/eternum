...
Eternum is achieved by accumulating **{formatNumberWithCommas(HYPERSTRUCTURE_POINTS_FOR_WIN)}** points. View and manage
...
{formatNumberWithCommas(EternumGlobalConfig.hyperstructures.hyperstructurePointsOnCompletion)} points, divided between
...
- **{EternumGlobalConfig.hyperstructures.hyperstructurePointsPerCycle} points** are generated each Eternum day
