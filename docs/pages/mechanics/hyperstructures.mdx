...
Eternum is achieved by accumulating **{formatNumberWithCommas(HYPERSTRUCTURE_POINTS_FOR_WIN)}** Victory Points. View and manage
...
{formatNumberWithCommas(EternumGlobalConfig.hyperstructures.hyperstructurePointsOnCompletion)} Victory Points, divided between
