...
Victory in Eternum is achieved by accumulating **{formatNumberWithCommas(HYPERSTRUCTURE_POINTS_FOR_WIN)}** Victory Points. While
...
Any player who accumulates the required number of Victory Points can call the END_GAME contract, which disables all further game
...
By completing them, players will earn achievement points and compete for positions on the achievement leaderboard. At the end of the
