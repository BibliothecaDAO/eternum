...
> ⚔️ **Takeover System**
>
> In-game Realms can be conquered within a Season, transferring control to the conqueror.
>
> Gameplay rights are restored at the start of the next Season, ensuring a dynamic and competitive environment.
