...
This is the only way to bridge in Lords to the game. This converts ERC20 Lords into in-game Lords. Only in-game Lords can be used to build and trade with.
