...
> NOTE: This is an internal engineering plan / roadmap. It is linked from the repo README to avoid mixing roadmap content into the project landing page.
...
4. Implement server handlers for HTTP history endpoints and realtime rooms (world, zone, location, direct) with username auth and rate limits.
