...
slot deployments create -t epic sepolia-rc-6 torii --version v1.0.5 --world 0x06ccdff2074b5642afa7204ea96b83a8d164727afa49e6f72a2c3e94693ab6ca --rpc https://api.cartridge.gg/x/starknet/sepolia --indexing.pending true --config ./torii-sepolia.toml
