...
slot deployments create eternum-42 katana --version v1.0.0-alpha.12 --invoke-max-steps 25000000 --disable-fee true --block-time 1000
...
slot deployments create eternum-42 torii --version v1.0.0-alpha.12 --world 0x76ca3dfc3e96843716f882546f0db96b7da0cf988bdba284b469d0defb2f48f --rpc https://api.cartridge.gg/x/eternum-42/katana --start-block 0  --index-pending true
