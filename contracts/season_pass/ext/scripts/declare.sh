...
#
# DESCRIPTION:
#   This script handles the declare process for the Season Pass smart 
#   contracts. It manages the build process using Scarb and executes the 
#   declare using Bun.
#
# USAGE:
#   ./declare.sh [network]  - Builds and declares the Season Pass contracts
...
echo -e "${GREEN}► Installing season pass declare dependencies...${NC}"
cd deployment
bun install
...
# Execute declare
echo -e "${GREEN}► Executing season pass declare script...${NC}"
bun run declare:${NETWORK}

echo -e "\n${GREEN}✔ Season Pass declare process completed on ${NETWORK}${NC}\n"