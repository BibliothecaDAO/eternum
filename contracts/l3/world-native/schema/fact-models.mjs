...
export function defineFactModels({ struct, model: declare }) {
  ...
  return [
    ...
    model("ArmyProgress", "game", struct("troops::ExplorerKey"), struct("progression::ArmyProgress")),
    ...
    model("ExpeditionSite", "game", struct("resources::ResourceKey"), struct("expeditions::ExpeditionSite")),
    ...
    model("RealmKnowledge", "game", [struct("resources::ResourceKey")[0], { name: "structure_id", type: "core::integer::u32" }], struct("research::RealmKnowledge")),
    model("ResearchNode", "game", [struct("resources::ResourceKey")[0], { name: "node", type: "core::integer::u8" }], struct("research::ResearchNode")),
    model("BuildingTierRule", "game", [...struct("buildings::BuildingRuleKey"), { name: "tier", type: "core::integer::u8" }], struct("research::BuildingTierRule")),
...
export const syncScopes = {
  ...
  ResourceProduction: { entities: ["entity_id"] },
  Structure: byEntity,
  BankName: byEntity,
