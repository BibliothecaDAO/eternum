...
export const nativeFactSchemaIdentity = "e75211e4b947beacb96424336cddec780629d90860927e4933495f46e8749fe3";
export interface NativeRows {
  ...
  PlayerCosmetics: { readonly game_id: number; readonly player: bigint; readonly attributes: readonly (bigint)[] };
...
export interface NativeKeys {
  ...
  PlayerCosmetics: { readonly game_id: number; readonly player: bigint };
...
export const nativeFactModels = {
  ...
  "SettlementRules": {
    ...
    "fields": {
      ...
      "reward_profile": "u8",
      "cosmetic_limit": "u8",
      "cosmetic_collection": "felt",
      "cosmetic_timelock": "felt"
    }
  },
  "SettlementProgress": {
    "keys": [
