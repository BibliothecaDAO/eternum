use eternum_cubit::f128::procgen::simplex3;
use eternum_cubit::f128::types::fixed::{Fixed, FixedTrait};
use eternum_cubit::f128::types::vec3::Vec3Trait;
use crate::fixed_constants as fc;
...
mod LEVEL {
    use eternum_cubit::f128::types::fixed::Fixed;
    use crate::fixed_constants as fc;
