...
trait ILiquiditySystems<T> {
    ...
    fn remove(ref self: T, game_id: u32, bank_entity_id: ID, entity_id: ID, resource_type: u8, shares: u128);
}
...
mod liquidity_systems {
    ...
    impl LiquiditySystemsImpl of super::ILiquiditySystems<ContractState> {
        fn add(
            ...
            let bank_structure_base: StructureBase = StructureBaseStoreImpl::retrieve(
                ref world, game_id, bank_entity_id,
            );
            ...
            let player_structure_base: StructureBase = StructureBaseStoreImpl::retrieve(ref world, game_id, entity_id);
            ...
            let mut market: Market = world.read_model((game_id, resource_type));
            ...
            let mut player_structure_weight: Weight = WeightStoreImpl::retrieve(ref world, game_id, entity_id);
            let player_resource_weight_grams: u128 = ResourceWeightImpl::grams(ref world, game_id, resource_type);
            ...
            player_structure_weight.store(ref world, game_id, entity_id);

            // increase player liquidity
            let mut player_liquidity: Liquidity = world.read_model((game_id, player_structure_owner, resource_type));
            player_liquidity.shares += liquidity_shares;

            world.write_model(@player_liquidity);

            InternalLiquiditySystemsImpl::emit_event(
                ref world, game_id, market, bank_entity_id, entity_id, cost_lords, cost_resource_amount, true,
            );
        }
        ...
        fn remove(
            ...
            let mut player_liquidity: Liquidity = world.read_model((game_id, caller, resource_type));
            ...
            if entity_id.is_non_zero() {
                ...
                let player_structure_owner: ContractAddress = StructureOwnerStoreImpl::retrieve(
                    ref world, game_id, entity_id,
                );
                player_structure_owner.assert_caller_owner();

                let mut player_structure_base: StructureBase = StructureBaseStoreImpl::retrieve(
                    ref world, game_id, entity_id,
                );
                ...
                let mut bank_structure_weight: Weight = WeightStoreImpl::retrieve(ref world, game_id, bank_entity_id);
                let mut player_structure_weight: Weight = WeightStoreImpl::retrieve(ref world, game_id, entity_id);
                ...
                player_structure_weight.store(ref world, game_id, entity_id);
                bank_structure_weight.store(ref world, game_id, bank_entity_id);
            } else {
                ////////////////////////////////////////////
                ...
                bridge_systems.lp_withdraw(game_id, caller, bank_entity_id, resource_type, payout_resource_amount);
                bridge_systems.lp_withdraw(game_id, caller, bank_entity_id, ResourceTypes::LORDS, payout_lords);
            }

            InternalLiquiditySystemsImpl::emit_event(
                ref world, game_id, market, bank_entity_id, entity_id, payout_lords, payout_resource_amount, false,
            );
        }
    }
