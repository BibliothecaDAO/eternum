...
#
# FILES:
#   - PID file: contracts/l3/game/pids/indexer.<network>.pid
#   - Log file: contracts/l3/game/logs/indexer.<network>.log
#   - Database: contracts/l3/game/torii-<network>.db
#
# EXAMPLES:
...
echo -e "${GREEN}✔ PID file: contracts/l3/game/${BOLD}$PID_FILE${NC}"
echo -e "${GREEN}✔ Log file: contracts/l3/game/${BOLD}$LOG_FILE${NC}"
echo -e ""
