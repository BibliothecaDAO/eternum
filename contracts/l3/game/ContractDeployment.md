...
- Open `contracts/l3/game/dojo_<network>.toml`
...
1. **Update the TOML file** (`contracts/l3/game/dojo_<network>.toml`):
...
- Copies ABI definitions from `contracts/l3/game/manifest_local.json` (source)
- Updates `contracts/l3/game/manifest_<network>.json` (target)
...
- Environment files are located in `apps/game/.env.<network>`
- Contract TOML files are in `contracts/l3/game/dojo_<network>.toml`
