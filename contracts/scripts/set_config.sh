...
export STARTING_ID_EARTHENSHARD=10
...
commands+=(
    ...
    "sozo execute $CONFIG_SYSTEMS set_mint_config --account-address $DOJO_ACCOUNT_ADDRESS --calldata $STARTING_ID_EARTHENSHARD,1,$EARTHENSHARD,$(($STARTING_RESOURCES * $RESOURCE_PRECISION))"
