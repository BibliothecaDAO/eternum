...
# =============================================================================
#     Realms lords Deployment Script
# =============================================================================
#
# DESCRIPTION:
#   This script handles the deployment process for the Realms lords smart 
#   contracts. It manages the build process using Scarb and executes the 
#   deployment using Bun.
#
# USAGE:
#   ./deploy.sh [network]  - Builds and deploys the Realms lords contracts
...
echo -e "\n"
echo -e "${BLUE}╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║               Building Realms lords Contracts             ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════════════════════╝${NC}"
echo -e "\n"

# Navigate to root contract directory
echo -e "${GREEN}► Navigating to realms lords contract root directory...${NC}"
cd ../../

# Build contracts
echo -e "${GREEN}► Building realms lords contracts with Scarb...${NC}"
scarb --release build
...
echo -e "${GREEN}► Installing realms lords deployment dependencies...${NC}"
cd deployment
bun install
...
# Execute deployment
echo -e "${GREEN}► Executing realms lords deployment script...${NC}"
bun run deploy:${NETWORK}

echo -e "\n${GREEN}✔ Realms lords deployment process completed on ${NETWORK}${NC}\n"