...
#
# DESCRIPTION:
#   This script handles the declare process for the Realms lords smart 
#   contracts. It manages the build process using Scarb and executes the 
#   declare using Bun.
#
# USAGE:
#   ./declare.sh [network]  - Builds and declares the Realms lords contracts
...
echo -e "${GREEN}► Installing realms lords declare dependencies...${NC}"
cd deployment
bun install
...
# Execute declare
echo -e "${GREEN}► Executing realms lords declare script...${NC}"
bun run declare:${NETWORK}

echo -e "\n${GREEN}✔ Realms lords declare process completed on ${NETWORK}${NC}\n"