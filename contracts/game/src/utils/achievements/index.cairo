...
pub impl AchievementImpl of AchievementTrait {
    ...
    fn declare_all(mut world: WorldStorage) {
        let mut achievements: Array<Achievement> = array![
            Self::first_realm(), Self::third_realm(), Self::seventh_realm(), Self::first_village(),
            Self::third_village(), Self::fifth_village(), Self::cartographer_one(), Self::cartographer_two(),
            Self::cartographer_three(), Self::biome_master(), Self::chance_encounter(), Self::shady_dealer(),
            Self::lost_and_found(), Self::ancient_discoverer(), Self::resource_tycoon_one(),
            Self::resource_tycoon_two(), Self::resource_tycoon_three(), Self::master_builder_one(),
            Self::master_builder_two(), Self::master_builder_three(), Self::chief_foreman_one(),
            Self::chief_foreman_two(), Self::chief_foreman_three(), Self::labor_powerhouse_one(),
            Self::labor_powerhouse_two(), Self::labor_powerhouse_three(), Self::bridger_one(), Self::bridger_two(),
            Self::bridger_three(), Self::blade_runner(), Self::nexus_six(), Self::first_blood(),
            Self::hardened_battler(), Self::seasoned_commander(), Self::tier_two_general(), Self::tier_three_general(),
            Self::petty_raider(), Self::feared_raider(), Self::fortress(), Self::city_planner(), Self::kingdom_come(),
            Self::imperial_ambition(), Self::village_elder(), Self::tribal_chief(), Self::contributor_one(),
            Self::contributor_two(), Self::contributor_three(), Self::points_collector_one(),
            Self::points_collector_two(), Self::points_collector_three(), Self::history_written_by_victor(),
        ];
