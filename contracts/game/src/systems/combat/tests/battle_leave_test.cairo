...
use s1_eternum::models::combat::{Army, Battle, BattleSide, Protectee, Protector, Troops, TroopsTrait};
...
use s1_eternum::utils::testing::{
    config::{get_combat_config, set_capacity_config, set_settlement_config}, general::{mint, spawn_realm},
