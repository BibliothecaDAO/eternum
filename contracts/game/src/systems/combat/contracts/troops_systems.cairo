...
//     fn guard_add(ref self: TContractState, for_structure_id: ID, category: TroopType, tier: TroopTier, amount: u128);
...
//             // todo: ensure guard health does not exceed max health
...
//             assert!(health.is_non_zero(), "health must be greater than 0");
