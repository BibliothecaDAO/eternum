...
//         let knight_balance_after_first_add = ResourceImpl::read_balance(ref world, realm_id,
...
//     #[test]
//     #[should_panic(expected: ("reached limit of structure guard troop count. max: 3000", 'ENTRYPOINT_FAILED'))]
...
//         // Act
//         let explorer_id = troop_management_systems.explorer_create(realm_id, category, tier, amount,
//         spawn_direction);
...
//         let starting_knight_t1_amount = 10 * RESOURCE_PRECISION;
//         tgrant_resources(ref world, realm_id, array![(ResourceTypes::KNIGHT_T1, starting_knight_t1_amount *
//         2)].span());
...
//     #[test]
//     #[should_panic(expected: ("reached limit of explorers amount per army. max: 3000", 'ENTRYPOINT_FAILED'))]
...
//         troop_management_systems.explorer_explorer_swap(from_explorer_id, to_explorer_id, swap_direction,
//         swap_amount);
...
//         assert(final_knight_balance_realm1 == starting_knight_t1_amount - create_amount_from, 'Final Balance Realm
//         1');
...
//         // Grant enough resources for two explorers
//         let starting_knight_t1_amount = 10 * RESOURCE_PRECISION;
//         tgrant_resources(ref world, realm_id_1, array![(ResourceTypes::KNIGHT_T1,
//         starting_knight_t1_amount)].span());
//         tgrant_resources(ref world, realm_id_2, array![(ResourceTypes::KNIGHT_T1,
//         starting_knight_t1_amount)].span());
