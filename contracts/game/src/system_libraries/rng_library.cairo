...
pub trait IRNGlibrary<T> {
    ...
    fn get_weighted_choice_bool_simple(self: @T, success_weight: u128, fail_weight: u128, random_number_seed: u256) -> bool;
    ...
    fn get_weighted_choice_direction(
        self: @T, population: Span<crate::models::position::Direction>, weights: Span<u128>, k: u128, r: bool, random_number_seed: u256,
    ) -> Span<crate::models::position::Direction>;
    fn get_weighted_choice_trooptier(
        self: @T, population: Span<crate::models::troop::TroopTier>, weights: Span<u128>,  k: u128, r: bool, random_number_seed: u256,
...
mod rng_library {    
    ...
    pub impl RngLibraryImpl of super::IRNGlibrary<ContractState> {
        ...
        fn get_weighted_choice_bool(
            self: @ContractState, population: Span<bool>, weights: Span<u128>,  k: u128, r: bool, random_number_seed: u256,
        ) -> Span<bool> {
            random::choices(population, weights, array![].span(), k, r, random_number_seed)
        }

        fn get_weighted_choice_bool_simple(self: @ContractState, success_weight: u128, fail_weight: u128, random_number_seed: u256) -> bool {
            *random::choices(
        ...
        fn get_weighted_choice_u128(
            self: @ContractState, population: Span<u128>, weights: Span<u128>, k: u128, r: bool, random_number_seed: u256,
        ) -> Span<u128> {
            random::choices(population, weights, array![].span(), k, r, random_number_seed)
        }

        fn get_weighted_choice_direction(
            self: @ContractState, population: Span<crate::models::position::Direction>, weights: Span<u128>, k: u128, r: bool, random_number_seed: u256,
        ) -> Span<crate::models::position::Direction> {
            random::choices(population, weights, array![].span(), k, r, random_number_seed)
        }

        fn get_weighted_choice_trooptier(
            self: @ContractState, population: Span<crate::models::troop::TroopTier>, weights: Span<u128>, k: u128, r: bool, random_number_seed: u256,
        ) -> Span<crate::models::troop::TroopTier> {
            random::choices(population, weights, array![].span(), k, r, random_number_seed)
        }

        fn get_weighted_choice_u8_u128_pair(
            self: @ContractState, population: Span<(u8, u128)>, weights: Span<u128>, k: u128, r: bool, random_number_seed: u256,
        ) -> Span<(u8, u128)> {
            random::choices(population, weights, array![].span(), k, r, random_number_seed)
        }
    }
