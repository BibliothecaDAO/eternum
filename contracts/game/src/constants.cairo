...
pub const UNIVERSAL_DEPLOYER_ADDRESS: felt252 = 0x041a78e741e5af2fec34b695679bc6891742439f7afb8484ecd7766661ad02bf;

pub const VELORDS_BURNER_ADDRESS: felt252 = 0x045c587318c9ebcf2fbe21febf288ee2e3597a21cd48676005a5770a50d433c5;
...
pub fn get_blitz_exploration_reward() -> Span<(u8, u128, u128)> {
    return array![
        ...
        (ResourceTypes::KNIGHT_T1, 1_000, 200),
        (ResourceTypes::CROSSBOWMAN_T1, 1_000, 200),
        (ResourceTypes::PALADIN_T1, 1_000, 200),
    ]
        .span();
}
