...
pub fn get_hyperstructure_point_multiplier(resource_type: u8) -> u128 {
    if resource_type == ResourceTypes::WOOD {
        return 100;
    }
    if resource_type == ResourceTypes::STONE {
        return 100;
    }
    if resource_type == ResourceTypes::COAL {
        return 100;
    }
    if resource_type == ResourceTypes::COPPER {
        return 100;
    }
    if resource_type == ResourceTypes::OBSIDIAN {
        return 100;
    }
    if resource_type == ResourceTypes::SILVER {
        return 100;
    }
    if resource_type == ResourceTypes::IRONWOOD {
        return 100;
    }
    if resource_type == ResourceTypes::COLD_IRON {
        return 100;
    }
    if resource_type == ResourceTypes::GOLD {
        return 100;
    }
    if resource_type == ResourceTypes::HARTWOOD {
        return 100;
    }
    if resource_type == ResourceTypes::DIAMONDS {
        return 100;
    }
    if resource_type == ResourceTypes::SAPPHIRE {
        return 100;
    }
    if resource_type == ResourceTypes::RUBY {
        return 100;
    }
    if resource_type == ResourceTypes::DEEP_CRYSTAL {
        return 100;
    }
    if resource_type == ResourceTypes::IGNIUM {
        return 100;
    }
    if resource_type == ResourceTypes::ETHEREAL_SILICA {
        return 100;
    }
    if resource_type == ResourceTypes::TRUE_ICE {
        return 100;
    }

    if resource_type == ResourceTypes::TWILIGHT_QUARTZ {
        return 100;
    }
    if resource_type == ResourceTypes::ALCHEMICAL_SILVER {
        return 100;
    }
    if resource_type == ResourceTypes::ADAMANTINE {
        return 100;
    }
    if resource_type == ResourceTypes::MITHRAL {
        return 100;
    }
    if resource_type == ResourceTypes::DRAGONHIDE {
        return 100;
    } else {
        panic!("unrecognized hyperstructure construction resource");
    }
    return 0;
}
