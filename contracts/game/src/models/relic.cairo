...
pub mod RELIC_EFFECT {
    ...
    pub const INCREASE_DAMAGE_30P_3D: u8 = 1;
    pub const REDUCE_DAMAGE_30P_3D: u8 = 2;
    pub const INSTANT_EXPLORE_1TILE: u8 = 3;
    pub const INSTANT_EXPLORE_2TILE: u8 = 4;
    pub const DOUBLE_EXPLORATION_REWARDS_3D: u8 = 5;
    pub const INCREASE_RESOURCE_PRODUCTION_30P_3D: u8 = 6;
    pub const INCREASE_LABOR_PRODUCTION_20P_8D: u8 = 7;
    pub const INCREASE_TROOP_PRODUCTION_20P_8D: u8 = 8;
}
