use crate::constants::RELICS_RESOURCE_START_ID;
use crate::models::resource::resource::RelicResourceImpl;
...
pub mod RELIC_EFFECT {
    ...
    pub const STRUCTURE_GUARD_REDUCE_ENEMY_ATTACK_DAMAGE_15P_3D: u8 = RELICS_RESOURCE_START_ID + 10;
    pub const STRUCTURE_GUARD_REDUCE_ENEMY_ATTACK_DAMAGE_30P_3D: u8 = RELICS_RESOURCE_START_ID + 11;
    ...
    pub const STRUCTURE_LABOR_PRODUCTION_INCREASE_20P_3D: u8 = RELICS_RESOURCE_START_ID + 14;
    pub const STRUCTURE_LABOR_PRODUCTION_INCREASE_20P_3D_ALT: u8 = RELICS_RESOURCE_START_ID + 15;
    pub const STRUCTURE_TROOP_PRODUCTION_INCREASE_15P_3D: u8 = RELICS_RESOURCE_START_ID + 16;
    pub const STRUCTURE_TROOP_PRODUCTION_INCREASE_30P_3D: u8 = RELICS_RESOURCE_START_ID + 17;
}
...
pub impl RelicEffectImpl of RelicEffectTrait {
    ...
    fn get_relic_effect(relic_resource_id: u8) -> (u16, u32, u8) {
        ...
        match id {
            ...
            9 => (20_000, 3, 0),
            // E11: reduce guard attack damage by 15% for 3 Eternum Days
            10 => (1_500, 3, 0),
            // E12: reduce guard attack damage by 30% for 3 Eternum Days
            11 => (3_000, 3, 0),
            ...
            13 => (4_000, 3, 0),
            // E15: increase structure labor production by 20% for 3 Eternum Days
            14 => (2_000, 3, 0),
            // E16: increase structure labor production by 20% for 3 Eternum Days
            15 => (2_000, 3, 0),
            // E17: increase structure troop production by 15% for 3 Eternum Days
            16 => (1_500, 3, 0),
            // E18: increase structure troop production by 30% for 3 Eternum Days
            17 => (3_000, 3, 0),
