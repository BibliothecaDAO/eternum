...
pub impl BlitzFeeSplitRecordImpl of BlitzFeeSplitRecordTrait {
    ...
    fn split_fees(ref self: BlitzFeeSplitRecord, total_fees: u128) {
        assert!(total_fees > 0, "Eternum: No prize to distribute");
        ...
        let creator_fee = PercentageImpl::get(total_fees, Self::creator_fee_percent());
        let players_fee = total_fees - creator_fee;
