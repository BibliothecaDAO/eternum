mod resource_transfer_system_tests {
    ...
    fn setup() -> (WorldStorage, IResourceSystemsDispatcher) {
        ...
        world.write_model_test(
            @CapacityConfig { category: CapacityConfigCategory::Donkey, weight_gram: 1_000_000 }
        );
    ...
    fn make_owner_and_receiver(ref world: WorldStorage, sender_entity_id: ID, receiver_entity_id: ID) {
        ...
        let receiver_entity_position: Position = Position { x: 200_000, y: 100_000, entity_id: receiver_entity_id.into() };
        world.write_model_test(@receiver_entity_position);
        world.write_model_test(
            @CapacityCategory { 
                entity_id: receiver_entity_id.into(), 
                category: CapacityConfigCategory::Structure 
            }
        );
        world.write_model_test(
            @Resource {
