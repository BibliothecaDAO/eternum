...
fn test_map_explore() {
    ...
    map_systems_dispatcher.explore(world, realm_army_unit_id, explore_tile_direction);
...
fn test_map_explore__ensure_explorer_cant_hex_travel_till_next_tick() {
    ...
    travel_systems_dispatcher.travel_hex(world, realm_army_unit_id, array![Direction::West].span());
}
