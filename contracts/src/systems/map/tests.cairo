...
use eternum::utils::testing::{
    ...
    constants::{MAP_EXPLORE_EXPLORATION_WHEAT_BURN_AMOUNT, MAP_EXPLORE_EXPLORATION_FISH_BURN_AMOUNT}
};
...
fn test_map_explore() {
    ...
    let expected_wheat_balance = INITIAL_WHEAT_BALANCE - (MAP_EXPLORE_EXPLORATION_WHEAT_BURN_AMOUNT * INITIAL_KNIGHT_BALANCE);
    let expected_fish_balance = INITIAL_FISH_BALANCE - (MAP_EXPLORE_EXPLORATION_FISH_BURN_AMOUNT * INITIAL_KNIGHT_BALANCE);
