...
fn setup() -> (IWorldDispatcher, Array<u128>, ICaravanSystemsDispatcher, u128) {
    ...
    let first_free_transport_unit_id = transport_unit_systems_dispatcher
        .create_free_unit(world, realm_entity_id, 10);
...
fn test_create_caravan() {
    ...
    // create caravan
    let caravan_id = caravan_systems_dispatcher.create(world, transport_units.clone());
...
fn test_create_caravan__blocked_entity() {
    let (world, mut transport_units, caravan_systems_dispatcher, _) = setup();
...
fn test_disassemble_caravan() {
    ...
    // disassemble caravan
    let disassembled_transport_ids = caravan_systems_dispatcher.disassemble(world, caravan_id);
...
fn test_disassemble_caravan__not_caravan() {
    let (world, _, caravan_systems_dispatcher, _) = setup();
