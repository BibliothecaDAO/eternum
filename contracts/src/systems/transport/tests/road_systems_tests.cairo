...
fn test_not_entity() {
    ...
    road_systems_dispatcher
        .create(
            world, entity_id, end_coord, // end first because order should not matter
             start_coord, 1
        );
}
...
fn test_insufficient_balance() {
    ...
    starknet::testing::set_contract_address(contract_address_const::<'entity'>());
    road_systems_dispatcher.create(world, entity_id, end_coord, start_coord, 50 // 50 * 10 > 400
    );
}
...
fn test_already_exists() {
    ...
    starknet::testing::set_contract_address(contract_address_const::<'entity'>());
    road_systems_dispatcher.create(world, entity_id, end_coord, start_coord, 1);
}
