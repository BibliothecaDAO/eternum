...
fn test_travel() {
    ...
    travel_systems_dispatcher.travel(world, travelling_entity_id.into(), destination_coord);
...
fn test_travel_hex() {
    ...
    // travelling entity travels
    starknet::testing::set_contract_address(contract_address_const::<'travelling_entity'>());
    travel_systems_dispatcher.travel_hex(world, travelling_entity_id.into(), travel_directions);
...
fn test_travel_hex__destination_tile_not_explored() {
    let (world, travelling_entity_id, _, travel_systems_dispatcher) = setup_hex_travel();
