...
use eternum::systems::config::interface::{
    ...
    ICapacityConfigDispatcherTrait, ICombatConfigDispatcher, ICombatConfigDispatcherTrait
};
...
fn setup() -> (IWorldDispatcher, u128, u128, u128, u128, ICombatSystemsDispatcher) {
    ...
    set!(
        world,
        (Resource {
            entity_id: attacker_realm_entity_id, resource_type: ResourceTypes::WHEAT, balance: 5000
        })
    );
    set!(
        world,
        (Resource {
            entity_id: attacker_realm_entity_id, resource_type: ResourceTypes::WOOD, balance: 5000
        })
    );
    ...
    set!(
        world,
        (Resource {
            entity_id: target_realm_entity_id, resource_type: ResourceTypes::WHEAT, balance: 5000
        })
    );
    set!(
        world,
        (Resource {
            entity_id: target_realm_entity_id, resource_type: ResourceTypes::WOOD, balance: 5000
        })
    );
...
fn test_attack() {
    ...
    // attack target
    combat_systems_dispatcher.attack(array![attacker_unit_id].span(), target_town_watch_id);
...
fn test_attacker_in_transit() {
    ...
    set!(world, (ArrivalTime { entity_id: attacker_unit_id, arrives_at: 1 }));
...
fn test_target_dead() {
    ...
    set!(world, (Health { entity_id: target_town_watch_id, value: 0 }));
