...
fn setup() -> (IWorldDispatcher, u128, Span<u128>, ISoldierSystemsDispatcher) {
    ...
    // create 2 soldiers
    let new_unit_id_1 = soldier_systems_dispatcher.create_soldiers(caller_id, 2);

    // create another 2 soldiers
    let new_unit_id_2 = soldier_systems_dispatcher.create_soldiers(caller_id, 2);
...
fn test_merge_to_town_watch() {
    ...
    soldier_systems_dispatcher
        .merge_soldiers(caller_town_watch_id, array![(*new_units.at(0), 2),].span());

    soldier_systems_dispatcher
        .merge_soldiers(caller_town_watch_id, array![(*new_units.at(1), 2),].span());
...
fn test_merge_to_raider() {
    ...
    soldier_systems_dispatcher
        .merge_soldiers(*new_units.at(0), array![(*new_units.at(1), 2),].span());
