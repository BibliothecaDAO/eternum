...
fn setup() -> (IWorldDispatcher, u128, u128, ISoldierSystemsDispatcher) {
    ...
    combat_config_dispatcher
        .set_health_config(
            SOLDIER_ENTITY_TYPE,
            array![ // pay for a unit of health with the following
...
fn test_heal_soldier() {
    ...
    soldier_systems_dispatcher.heal_soldiers(new_unit_id, health_bought);
...
fn test_not_unit_owner() {
    let (_, _, new_unit_id, soldier_systems_dispatcher) = setup();
