...
fn setup() -> (IWorldDispatcher, u128, u128, ISoldierSystemsDispatcher) {
    ...
    let new_unit_id = soldier_systems_dispatcher
        .create_soldiers(world, caller_id, num_soldiers_bought);
...
fn test_detach_unit() {
    ...
    let new_unit_id = soldier_systems_dispatcher
        .detach_soldiers(world, unit_id, num_detached_soldiers);
...
fn test_not_owner() {
    ...
    // detach 7 soldiers from unit
    let num_detached_soldiers = 7;
    soldier_systems_dispatcher.detach_soldiers(world, unit_id, num_detached_soldiers);
}
