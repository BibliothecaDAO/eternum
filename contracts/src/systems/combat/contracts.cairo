...
mod combat_systems {
    ...
    impl SoldierSystemsImpl of ISoldierSystems<ContractState> {
        ...
        ///
        fn create_soldiers(
            self: @ContractState, world: IWorldDispatcher, realm_entity_id: u128, quantity: u128
        ) -> ID {
        ...
        ///
        fn detach_soldiers(
            self: @ContractState, world: IWorldDispatcher, unit_id: u128, detached_quantity: u128
        ) -> ID {
    ...
    impl CombatSystemsImpl of ICombatSystems<ContractState> {
        ...
        /// - target_entity_id: realm's town watch id or another entity army
        fn steal(
            self: @ContractState, world: IWorldDispatcher, attacker_id: u128, target_entity_id: u128
        ) {
            let caller = starknet::get_caller_address();
            let ts = starknet::get_block_timestamp();
