...
mod trade_systems {
    ...
    impl TradeSystemsImpl of super::ITradeSystems<ContractState> {
        fn create_order(
            ...
            loop {
                match maker_gives_resources.pop_front() {
                    Option::Some((resource_type, resource_amount)) => {
                        ...
                        let mut maker_resource: Resource 
                            = ResourceImpl::get(world, (maker_id, *resource_type));
            ...
            let mut maker_donkey_resource = ResourceImpl::get(world, (maker_id, ResourceTypes::DONKEY));
        ...
        fn accept_order(world: IWorldDispatcher, 
            taker_id: u128, 
            trade_id: u128, 
            mut maker_gives_resources: Span<(u8, u128)>,
            mut taker_gives_resources: Span<(u8, u128)>
            ...
            let (_, taker_receives_resources_hash, _) 
                = internal_resources::transfer(
            ...
            let (_, maker_receives_resources_hash, _) 
                = internal_resources::transfer(
        ...
        fn cancel_order(
            world: IWorldDispatcher, 
            trade_id: u128, 
            mut return_resources: Span<(u8, u128)>,
        ) {
            ...
            let (_, maker_receives_resources_hash, resources_weight) 
                = internal_resources::transfer(
            ...
            let mut maker_donkey_resource: Resource 
                = ResourceImpl::get(world, (trade.maker_id, ResourceTypes::DONKEY));
