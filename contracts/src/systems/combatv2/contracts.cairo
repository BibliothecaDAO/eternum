...
mod combat_v2_systems {
    ...
    use eternum::models::{combatV2::{ArmyImpl, Troop, TroopImpl, Fighters}, combatV2::{BattleImpl}};
    ...
    impl Combatv2ContractImpl of ICombatv2Contract<ContractState> {
        ...
        fn merge_army(
            world: IWorldDispatcher, army_entity_id_a: u128, army_entity_id_b: u128,
        ) { // ArmyImpl::merge(entity_id, troops, world);
        }

        fn start_battle(
            world: IWorldDispatcher, army_entity_id: u128, defending_entity_id: u128
        ) { // BattleImpl::start(army_entity_id, defending_entity_id, world);
        }

        fn end_battle(
            world: IWorldDispatcher, battle_entity_id: u128, army_entity_id: u128
