...
fn test_create_bank() {
    ...
    assert_eq!(bank_position.x, 30, "wrong x position");
    assert_eq!(bank_position.y, 800, "wrong y position");
    ...
    assert_eq!(bank_shekel_swap_cost_1.resource_cost_count, 2, "wrong resource cost count");

    let bank_shekel_wheat_cost = get!(world, (bank_shekel_swap_cost_1.resource_cost_id, 0), ResourceCost);
    assert_eq!(bank_shekel_wheat_cost.amount, 500, "wrong wheat cost");

    let bank_shekel_fish_cost = get!(world, (bank_shekel_swap_cost_1.resource_cost_id, 1), ResourceCost);
    assert_eq!(bank_shekel_fish_cost.amount, 200, "wrong fish cost");
    ...
    assert_eq!(bank_shekel_swap_cost_2.resource_cost_count, 1, "wrong resource cost count");

    let bank_shekel_dragonhide_cost = get!(world, (bank_shekel_swap_cost_2.resource_cost_id, 0), ResourceCost);
    assert_eq!(bank_shekel_dragonhide_cost.amount, 700, "wrong dragonhide cost");
}
...
fn test_set_bank_auction() {
    ...
    assert_eq!(bank_shekel_auction.decay_constant_mag, decay_constant, "decay_constant_mag");
    assert_eq!(bank_shekel_auction.per_time_unit, per_time_unit, "per_time_unit");
    assert_eq!(bank_shekel_auction.sold, 0, "sold");
    assert!(!bank_shekel_auction.decay_constant_sign, "decay_constant_sign");
    assert_eq!(bank_shekel_auction.price_update_interval, 10, "price_update_interval");

    let bank_dragonhide_auction = get!(world, (bank_id, ResourceTypes::DRAGONHIDE, 0), BankAuction);
    assert_eq!(bank_dragonhide_auction.decay_constant_mag, decay_constant, "decay_constant_mag");
    assert_eq!(bank_dragonhide_auction.per_time_unit, per_time_unit, "per_time_unit");
    assert_eq!(bank_dragonhide_auction.sold, 0, "sold");
    assert!(!bank_dragonhide_auction.decay_constant_sign, "decay_constant_sign");
    assert_eq!(bank_dragonhide_auction.price_update_interval, 10, "price_update_interval");
}
