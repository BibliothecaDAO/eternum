...
fn test_bank_swap_for_wheat_fish_and_coal() {
    ...
    bank_systems_dispatcher
        .swap(world, bank_id, 0, transport_id, ResourceTypes::LORDS, lords_bought);
...
fn test_bank_swap_for_dragonhide() {
    ...
    bank_systems_dispatcher
        .swap(world, bank_id, 1, transport_id, ResourceTypes::LORDS, lords_bought);
...
fn test_bank_swap__no_auction() {
    ...
    bank_systems_dispatcher
        .swap(world, bank_id, 0, transport_id, ResourceTypes::DRAGONHIDE, dragonhide_bought);
}
