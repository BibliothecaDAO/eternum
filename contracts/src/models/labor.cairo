...
mod tests {
    ...
    fn test_compute_new_labor_is_complete() {
        ...
        assert_eq!(new_labor.last_harvest, 50, "last_harvest is not 50");
        assert_eq!(new_labor.balance, 210, "balance is not 210");
        assert_eq!(new_labor.multiplier, 1, "multiplier not 1");
    }
    ...
    fn test_compute_new_labor_not_complete() {
        ...
        assert_eq!(new_labor.last_harvest, 0, "last_harvest is not 0");
        assert_eq!(new_labor.balance, 260, "balance is not 260");
        assert_eq!(new_labor.multiplier, 1, "multiplier not 1");
    }
}