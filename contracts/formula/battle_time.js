...
class TroopConfig {
    constructor(health, knightStrength, paladinStrength, crossbowmanStrength, advantagePercent, disadvantagePercent, battleTimeScale) {
        this.health = health;
...
class Battle {
    ...
    strengthAgainst(attacker, defender) {
        ...
        let attackerKnightStrengthWithAdvantage = attackerKnightStrength + Math.floor(
            (defenderPaladinStrength * this.config.advantagePercent) / attackerKnightStrength / Percentage._100()
        );
        ...
        let attackerKnightStrengthWithAdvantageMax = attackerKnightStrength +
            Percentage.get(attackerKnightStrength, this.config.advantagePercent);
        ...
        let attackerKnightStrengthWithDisadvantage = attackerKnightStrength - Math.floor(
        ...
        let attackerKnightStrengthWithDisadvantageMax = attackerKnightStrength -
            Percentage.get(attackerKnightStrength, this.config.disadvantagePercent);
        ...
        let attackerCrossbowmanStrengthWithAdvantage = attackerCrossbowmanStrength + Math.floor(
            (defenderKnightStrength * this.config.advantagePercent) / attackerCrossbowmanStrength / Percentage._100()
        );
        let attackerCrossbowmanStrengthWithAdvantageMax = attackerCrossbowmanStrength +
            Percentage.get(attackerCrossbowmanStrength, this.config.advantagePercent);
        ...
        let attackerCrossbowmanStrengthWithDisadvantage = attackerCrossbowmanStrength - Math.floor(
            (defenderPaladinStrength * this.config.disadvantagePercent) / attackerCrossbowmanStrength / Percentage._100()
        );
        let attackerCrossbowmanStrengthWithDisadvantageMax = attackerCrossbowmanStrength -
            Percentage.get(attackerCrossbowmanStrength, this.config.disadvantagePercent);
        ...
        let attackerPaladinStrengthWithAdvantage = attackerPaladinStrength + Math.floor(
            (defenderCrossbowmanStrength * this.config.advantagePercent) / attackerPaladinStrength / Percentage._100()
        );
        let attackerPaladinStrengthWithAdvantageMax = attackerPaladinStrength +
            Percentage.get(attackerPaladinStrength, this.config.advantagePercent);
        ...
        let attackerPaladinStrengthWithDisadvantage = attackerPaladinStrength - Math.floor(
            (defenderKnightStrength * this.config.disadvantagePercent) / attackerPaladinStrength / Percentage._100()
        );
        let attackerPaladinStrengthWithDisadvantageMax = attackerPaladinStrength -
            Percentage.get(attackerPaladinStrength, this.config.disadvantagePercent);
        ...
        let attackerTotalKnightStrength = attackerKnightStrength
        ...
        let attackerTotalCrossbowmanStrength = attackerCrossbowmanStrength
        ...
        let attackerTotalPaladinStrength = attackerPaladinStrength
        ...
        let attackerTotalStrength = attackerTotalKnightStrength
            + attackerTotalCrossbowmanStrength
            + attackerTotalPaladinStrength;
    ...
    computeDelta() {
        ...
        const attackSecondsTillDeathScaled = 1 + Math.floor(
            (this.attackArmy.count() * attackSecondsToDie) / this.config.battleTimeScale
        );
        ...
        const defenceSecondsTillDeathScaled = 1 + Math.floor(
            (this.defenceArmy.count() * defenceSecondsToDie) / this.config.battleTimeScale
        );
