...
- explanatory without turning into a changelog dump
- specific about what changed and why it matters
- honest about verification and what was not tested

They should not read like:

- autogenerated release notes
- a dry file-move inventory
- vague cleanup language with no explanation
- robotic bullet spam

For PR descriptions:

- start with the shape of the change in plain language
- explain why the change was needed
- group related changes into a few meaningful sections
- mention verification in a short concrete list
- mention important non-goals or things not tested when relevant

Prefer:

- "This pulls the clean deployer apart into clearer ownership boundaries so the launch path, role grants, and shared
  helpers stop competing in one flat folder."
- "The goal here is readability and safer extension, not behavior changes for operators."

Avoid:

- "Updated files to improve structure"
- "Various cleanup changes"
- "Implemented requested updates across multiple modules"
