locals {
  environment_id = "mainnet.eternum"
  account_class  = "dr"
  aws_region     = "us-west-2"
  project_name   = "eternum-dr-eternum-runtime"
}
...
variable "existing_certificate_arn" {
  description = "Validated us-west-2 ACM certificate for the production runtime hostnames."
  type        = string
}
...
module "runtime_environment" {
  ...
  ecr_repository_name                 = "eternum-mainnet-eternum-runtime"
