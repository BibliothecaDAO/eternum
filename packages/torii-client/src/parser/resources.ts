...
export const getResourcesFromToriiEntity = (entity: any): ComponentValue<ClientComponents["Resource"]["schema"]> => {
  return {
    ...
    STONE_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.STONE_PRODUCTION.value.unclaimed_amount.value),
    ...
    COAL_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.COAL_PRODUCTION.value.unclaimed_amount.value),
    ...
    WOOD_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.WOOD_PRODUCTION.value.unclaimed_amount.value),
    ...
    COPPER_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.COPPER_PRODUCTION.value.unclaimed_amount.value),
    ...
    IRONWOOD_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.IRONWOOD_PRODUCTION.value.unclaimed_amount.value),
    ...
    OBSIDIAN_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.OBSIDIAN_PRODUCTION.value.unclaimed_amount.value),
    ...
    GOLD_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.GOLD_PRODUCTION.value.unclaimed_amount.value),
    ...
    SILVER_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.SILVER_PRODUCTION.value.unclaimed_amount.value),
    ...
    MITHRAL_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.MITHRAL_PRODUCTION.value.unclaimed_amount.value),
    ...
    ALCHEMICAL_SILVER_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.ALCHEMICAL_SILVER_PRODUCTION.value.unclaimed_amount.value),
    ...
    COLD_IRON_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.COLD_IRON_PRODUCTION.value.unclaimed_amount.value),
    ...
    DEEP_CRYSTAL_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.DEEP_CRYSTAL_PRODUCTION.value.unclaimed_amount.value),
    ...
    RUBY_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.RUBY_PRODUCTION.value.unclaimed_amount.value),
    ...
    DIAMONDS_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.DIAMONDS_PRODUCTION.value.unclaimed_amount.value),
    ...
    HARTWOOD_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.HARTWOOD_PRODUCTION.value.unclaimed_amount.value),
    ...
    IGNIUM_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.IGNIUM_PRODUCTION.value.unclaimed_amount.value),
    ...
    TWILIGHT_QUARTZ_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.TWILIGHT_QUARTZ_PRODUCTION.value.unclaimed_amount.value),
    ...
    TRUE_ICE_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.TRUE_ICE_PRODUCTION.value.unclaimed_amount.value),
    ...
    ADAMANTINE_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.ADAMANTINE_PRODUCTION.value.unclaimed_amount.value),
    ...
    SAPPHIRE_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.SAPPHIRE_PRODUCTION.value.unclaimed_amount.value),
    ...
    ETHEREAL_SILICA_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.ETHEREAL_SILICA_PRODUCTION.value.unclaimed_amount.value),
    ...
    DRAGONHIDE_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.DRAGONHIDE_PRODUCTION.value.unclaimed_amount.value),
    ...
    LABOR_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.LABOR_PRODUCTION.value.unclaimed_amount.value),
    ...
    EARTHEN_SHARD_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.EARTHEN_SHARD_PRODUCTION.value.unclaimed_amount.value),
    ...
    DONKEY_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.DONKEY_PRODUCTION.value.unclaimed_amount.value),
    ...
    KNIGHT_T1_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.KNIGHT_T1_PRODUCTION.value.unclaimed_amount.value),
    ...
    KNIGHT_T2_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.KNIGHT_T2_PRODUCTION.value.unclaimed_amount.value),
    ...
    KNIGHT_T3_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.KNIGHT_T3_PRODUCTION.value.unclaimed_amount.value),
    ...
    CROSSBOWMAN_T1_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.CROSSBOWMAN_T1_PRODUCTION.value.unclaimed_amount.value),
    ...
    CROSSBOWMAN_T2_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.CROSSBOWMAN_T2_PRODUCTION.value.unclaimed_amount.value),
    ...
    CROSSBOWMAN_T3_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.CROSSBOWMAN_T3_PRODUCTION.value.unclaimed_amount.value),
    ...
    PALADIN_T1_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.PALADIN_T1_PRODUCTION.value.unclaimed_amount.value),
    ...
    PALADIN_T2_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.PALADIN_T2_PRODUCTION.value.unclaimed_amount.value),
    ...
    PALADIN_T3_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.PALADIN_T3_PRODUCTION.value.unclaimed_amount.value),
    ...
    WHEAT_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.WHEAT_PRODUCTION.value.unclaimed_amount.value),
    ...
    FISH_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.FISH_PRODUCTION.value.unclaimed_amount.value),
    ...
    LORDS_PRODUCTION: {
      ...
      unclaimed_amount: BigInt(entity.LORDS_PRODUCTION.value.unclaimed_amount.value),
