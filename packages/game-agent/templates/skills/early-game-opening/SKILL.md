...
- Game just started (tick 0-100)
- No information about opponent yet
- Need to establish economic foundation
...
- **Scout sees enemy military early**: Switch to defending-a-rush skill
- **Map is wide open**: Consider aggressive expansion
- **Enemy also booming**: Safe to continue economic focus

## Common Mistakes

- Building military too early (wastes resources on units that aren't needed yet)
- Not scouting (flying blind leads to bad decisions)
- Expanding without scouting first (expansion could be in danger)
