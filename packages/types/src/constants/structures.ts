...
export const BuildingTypeToString: Record<BuildingType, string> = {
  ...
  [BuildingType.ResourceAncientFragment]: "Ancient Fragment",
  [BuildingType.ResourceDonkey]: "Market",
  [BuildingType.ResourceKnightT1]: "Knight T1",
  [BuildingType.ResourceKnightT2]: "Knight T2",
  [BuildingType.ResourceKnightT3]: "Knight T3",
  [BuildingType.ResourceCrossbowmanT1]: "Crossbowman T1",
  [BuildingType.ResourceCrossbowmanT2]: "Crossbowman T2",
  [BuildingType.ResourceCrossbowmanT3]: "Crossbowman T3",
  [BuildingType.ResourcePaladinT1]: "Paladin T1",
  [BuildingType.ResourcePaladinT2]: "Paladin T2",
  [BuildingType.ResourcePaladinT3]: "Paladin T3",
