...
/**
 * The six tiles around a structure in ring order, each open when an army can be raised onto it; a closed tile is
 * either explored and taken, or not yet explored.
 */
