...
export const ARMY_MOVEMENT_LATENCY_PHASE_PAIRS: readonly ArmyMovementLatencyPhasePair[] = [
  ...
  { from: "explore_intent_queued", to: "explore_tx_hash_received" },
  { from: "explore_tx_hash_received", to: "explore_authoritative_reconcile_complete" },
  { from: "explore_intent_queued", to: "explore_next_safe_unblocked" },
