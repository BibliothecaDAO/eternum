...
export const getResourcesFromToriiEntity = (entity: any): ComponentValue<ClientComponents["Resource"]["schema"]> => {
  return {
    ...
    SATOSHI_BALANCE: BigInt(entity.SATOSHI_BALANCE?.value ?? 0),
    ...
    STONE_PRODUCTION: {
      ...
      production_rate: Number(entity.STONE_PRODUCTION.value.production_rate.value),
    ...
    COAL_PRODUCTION: {
      ...
      production_rate: Number(entity.COAL_PRODUCTION.value.production_rate.value),
    ...
    WOOD_PRODUCTION: {
      ...
      production_rate: Number(entity.WOOD_PRODUCTION.value.production_rate.value),
    ...
    COPPER_PRODUCTION: {
      ...
      production_rate: Number(entity.COPPER_PRODUCTION.value.production_rate.value),
    ...
    IRONWOOD_PRODUCTION: {
      ...
      production_rate: Number(entity.IRONWOOD_PRODUCTION.value.production_rate.value),
    ...
    OBSIDIAN_PRODUCTION: {
      ...
      production_rate: Number(entity.OBSIDIAN_PRODUCTION.value.production_rate.value),
    ...
    GOLD_PRODUCTION: {
      ...
      production_rate: Number(entity.GOLD_PRODUCTION.value.production_rate.value),
    ...
    SILVER_PRODUCTION: {
      ...
      production_rate: Number(entity.SILVER_PRODUCTION.value.production_rate.value),
    ...
    MITHRAL_PRODUCTION: {
      ...
      production_rate: Number(entity.MITHRAL_PRODUCTION.value.production_rate.value),
    ...
    ALCHEMICAL_SILVER_PRODUCTION: {
      ...
      production_rate: Number(entity.ALCHEMICAL_SILVER_PRODUCTION.value.production_rate.value),
    ...
    COLD_IRON_PRODUCTION: {
      ...
      production_rate: Number(entity.COLD_IRON_PRODUCTION.value.production_rate.value),
    ...
    DEEP_CRYSTAL_PRODUCTION: {
      ...
      production_rate: Number(entity.DEEP_CRYSTAL_PRODUCTION.value.production_rate.value),
    ...
    RUBY_PRODUCTION: {
      ...
      production_rate: Number(entity.RUBY_PRODUCTION.value.production_rate.value),
    ...
    DIAMONDS_PRODUCTION: {
      ...
      production_rate: Number(entity.DIAMONDS_PRODUCTION.value.production_rate.value),
    ...
    HARTWOOD_PRODUCTION: {
      ...
      production_rate: Number(entity.HARTWOOD_PRODUCTION.value.production_rate.value),
    ...
    IGNIUM_PRODUCTION: {
      ...
      production_rate: Number(entity.IGNIUM_PRODUCTION.value.production_rate.value),
    ...
    TWILIGHT_QUARTZ_PRODUCTION: {
      ...
      production_rate: Number(entity.TWILIGHT_QUARTZ_PRODUCTION.value.production_rate.value),
    ...
    TRUE_ICE_PRODUCTION: {
      ...
      production_rate: Number(entity.TRUE_ICE_PRODUCTION.value.production_rate.value),
    ...
    ADAMANTINE_PRODUCTION: {
      ...
      production_rate: Number(entity.ADAMANTINE_PRODUCTION.value.production_rate.value),
    ...
    SAPPHIRE_PRODUCTION: {
      ...
      production_rate: Number(entity.SAPPHIRE_PRODUCTION.value.production_rate.value),
    ...
    ETHEREAL_SILICA_PRODUCTION: {
      ...
      production_rate: Number(entity.ETHEREAL_SILICA_PRODUCTION.value.production_rate.value),
    ...
    DRAGONHIDE_PRODUCTION: {
      ...
      production_rate: Number(entity.DRAGONHIDE_PRODUCTION.value.production_rate.value),
    ...
    LABOR_PRODUCTION: {
      ...
      production_rate: Number(entity.LABOR_PRODUCTION.value.production_rate.value),
    ...
    EARTHEN_SHARD_PRODUCTION: {
      ...
      production_rate: Number(entity.EARTHEN_SHARD_PRODUCTION.value.production_rate.value),
    ...
    DONKEY_PRODUCTION: {
      ...
      production_rate: Number(entity.DONKEY_PRODUCTION.value.production_rate.value),
    ...
    KNIGHT_T1_PRODUCTION: {
      ...
      production_rate: Number(entity.KNIGHT_T1_PRODUCTION.value.production_rate.value),
    ...
    KNIGHT_T2_PRODUCTION: {
      ...
      production_rate: Number(entity.KNIGHT_T2_PRODUCTION.value.production_rate.value),
    ...
    KNIGHT_T3_PRODUCTION: {
      ...
      production_rate: Number(entity.KNIGHT_T3_PRODUCTION.value.production_rate.value),
    ...
    CROSSBOWMAN_T1_PRODUCTION: {
      ...
      production_rate: Number(entity.CROSSBOWMAN_T1_PRODUCTION.value.production_rate.value),
    ...
    CROSSBOWMAN_T2_PRODUCTION: {
      ...
      production_rate: Number(entity.CROSSBOWMAN_T2_PRODUCTION.value.production_rate.value),
    ...
    CROSSBOWMAN_T3_PRODUCTION: {
      ...
      production_rate: Number(entity.CROSSBOWMAN_T3_PRODUCTION.value.production_rate.value),
    ...
    PALADIN_T1_PRODUCTION: {
      ...
      production_rate: Number(entity.PALADIN_T1_PRODUCTION.value.production_rate.value),
    ...
    PALADIN_T2_PRODUCTION: {
      ...
      production_rate: Number(entity.PALADIN_T2_PRODUCTION.value.production_rate.value),
    ...
    PALADIN_T3_PRODUCTION: {
      ...
      production_rate: Number(entity.PALADIN_T3_PRODUCTION.value.production_rate.value),
    ...
    WHEAT_PRODUCTION: {
      ...
      production_rate: Number(entity.WHEAT_PRODUCTION.value.production_rate.value),
    ...
    FISH_PRODUCTION: {
      ...
      production_rate: Number(entity.FISH_PRODUCTION.value.production_rate.value),
    ...
    LORDS_PRODUCTION: {
      ...
      production_rate: Number(entity.LORDS_PRODUCTION.value.production_rate.value),
    ...
    ESSENCE_PRODUCTION: {
      ...
      production_rate: Number(entity.ESSENCE_PRODUCTION.value.production_rate.value),
    ...
    SATOSHI_PRODUCTION: {
      building_count: entity.SATOSHI_PRODUCTION?.value?.building_count?.value ?? 0,
      production_rate: Number(entity.SATOSHI_PRODUCTION?.value?.production_rate?.value ?? 0),
      output_amount_left: BigInt(entity.SATOSHI_PRODUCTION?.value?.output_amount_left?.value ?? 0),
      last_updated_at: entity.SATOSHI_PRODUCTION?.value?.last_updated_at?.value ?? 0,
    },
    RESEARCH_PRODUCTION: {
      building_count: entity.RESEARCH_PRODUCTION?.value?.building_count?.value ?? 0,
      production_rate: Number(entity.RESEARCH_PRODUCTION?.value?.production_rate?.value ?? 0),
