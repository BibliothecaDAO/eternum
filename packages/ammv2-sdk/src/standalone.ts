...
export const DEFAULT_STANDALONE_AMMV2_ROUTER_ADDRESS = "0xf00d3" as const;
export const DEFAULT_STANDALONE_AMMV2_INDEXER_URL = "http://127.0.0.1:3001" as const;
export const DEFAULT_STANDALONE_AMMV2_LORDS_ADDRESS = normalizeAddress(mainnetSeasonAddresses.lords);

export const STANDALONE_AMM_RESOURCES = STANDALONE_AMM_RESOURCE_ENTRIES.filter(
  (resource) => resource.address !== DEFAULT_STANDALONE_AMMV2_LORDS_ADDRESS,
);
