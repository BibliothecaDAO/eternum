...
export const Compass = () => {
  ...
  return (
    <div className="w-full flex items-center">
      <div className="relative h-12 w-12 flex outline-1 outline outline-gold transition-transform duration-100 items-center justify-center text-gold rounded-full shadow-md border-2 border-black shadow-black/50"
        style={{
          backgroundImage:
