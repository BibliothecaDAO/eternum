  ...
  return (
    <div className="w-full flex items-center">
      ...
      >
        ...
        <div className="absolute top-[-2px] text-xxs" style={{ transform: `rotate(${direction * -1}deg)` }}>N</div>
        <div className="absolute right-[2px] text-xxs opacity-80" style={{ transform: `rotate(${direction * -1}deg)` }}>E</div>
        <div className="absolute bottom-[-3px] text-xxs opacity-80" style={{ transform: `rotate(${direction * -1}deg)` }}>S</div>
        <div className="absolute left-0 text-xxs opacity-80" style={{ transform: `rotate(${direction * -1}deg)` }}>W</div>
