    ...
    <>
      {tooltip && tooltip.content && (
        <div
          ref={ref}
          className={clsx(
            "fixed z-[100] inline-flex border-gradient border-2  text-xxs -translate-x-1/2 px-4 py-1 bg-brown flex-col justify-start items-center text-gold leading-loose ",
