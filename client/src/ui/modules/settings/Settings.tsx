...
export const SettingsWindow = () => {
  ...
  // const donkeyWeightLimit = useUIStore((state) => state.donkeyWeightLimit);
  // const setDonkeyWeightLimit = useUIStore((state) => state.setDonkeyWeightLimit);
    ...
    <OSWindow onClick={() => togglePopup(settings)} show={isOpen} title={settings}>
      ...
      <div className="flex flex-col p-3 space-y-2">
        ...
        <div className="text-xs text-white/50 mb-2">
          Current minimum weight: {currencyIntlFormat(donkeyWeightLimit)} kg
        </div>
        <RangeInput
