...
export function useCaravan() {
  ...
  const getCaravanInfo = (caravanId: bigint): CaravanInterface => {
    ...
    return {
      ...
      destination,
      owner: owner?.address,
      isMine: padAddress(owner?.address.toString()) === padAddress(account.address),
    };
  };
