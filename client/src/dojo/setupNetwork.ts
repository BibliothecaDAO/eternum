...
export async function setupNetwork() {
    ...
    // TODO: add when torii is impl in syncWorker
    // const syncWorker = new SyncWorker(provider, contractComponents, EVENT_KEY, TORII_URL);
    ...
    return {
        ...
        entities: async (component: string, partition: string, length: number) => provider.entities(component, partition, lenght),
        world,
        syncWorker
    };
}