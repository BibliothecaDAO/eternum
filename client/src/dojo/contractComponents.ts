...
export function defineContractComponents(world: World) {
  return {
	  ...
	  BankAuction: (() => {
	    return defineComponent(
	      world,
	      { bank_id: RecsType.BigInt, bank_gives_resource_type: RecsType.Number, bank_swap_resource_cost_index: RecsType.Number, decay_constant_mag: RecsType.BigInt, decay_constant_sign: RecsType.Boolean, per_time_unit: RecsType.BigInt, start_time: RecsType.Number, sold: RecsType.BigInt, price_update_interval: RecsType.BigInt },
	      {
	        metadata: {
	          name: "BankAuction",
	  ...
	  BuildingCost: (() => {
	    return defineComponent(
	      world,
	      { config_id: RecsType.BigInt, building_cost_config_id: RecsType.BigInt, resource_type: RecsType.BigInt, cost: RecsType.BigInt },
	      {
	        metadata: {
	          name: "BuildingCost",
	  ...
	  BuildingTypeConfig: (() => {
	    return defineComponent(
	      world,
	      { config_id: RecsType.BigInt, building_type_config_id: RecsType.BigInt, id: RecsType.BigInt, sqm: RecsType.BigInt, resource_types_packed: RecsType.BigInt, resource_types_count: RecsType.Number },
	      {
	        metadata: {
	  ...
	  LaborConfig: (() => {
	    return defineComponent(
	      world,
	      { config_id: RecsType.BigInt, base_labor_units: RecsType.Number, base_resources_per_cycle: RecsType.BigInt, base_food_per_cycle: RecsType.BigInt },
	      {
	        metadata: {
	          name: "LaborConfig",
	  ...
	  LevelingConfig: (() => {
	    return defineComponent(
	      world,
	      { config_id: RecsType.BigInt, decay_interval: RecsType.Number, max_level: RecsType.Number, decay_scaled: RecsType.BigInt, cost_percentage_scaled: RecsType.BigInt, base_multiplier: RecsType.BigInt, wheat_base_amount: RecsType.BigInt, fish_base_amount: RecsType.BigInt, resource_1_cost_id: RecsType.BigInt, resource_1_cost_count: RecsType.Number, resource_2_cost_id: RecsType.BigInt, resource_2_cost_count: RecsType.Number, resource_3_cost_id: RecsType.BigInt, resource_3_cost_count: RecsType.Number },
	      {
	        metadata: {
	          name: "LevelingConfig",
	  ...
	  RoadConfig: (() => {
	    return defineComponent(
	      world,
	      { config_id: RecsType.BigInt, fee_resource_type: RecsType.Number, fee_amount: RecsType.BigInt, speed_up_by: RecsType.Number },
	      {
	        metadata: {
	          name: "RoadConfig",
	  ...
	  Labor: (() => {
	    return defineComponent(
	      world,
	      { entity_id: RecsType.BigInt, resource_type: RecsType.Number, balance: RecsType.Number, last_harvest: RecsType.Number, multiplier: RecsType.Number },
	      {
	        metadata: {
	          name: "Labor",
	  ...
	  LaborAuction: (() => {
	    return defineComponent(
	      world,
	      { zone: RecsType.Number, decay_constant_mag: RecsType.BigInt, decay_constant_sign: RecsType.Boolean, per_time_unit: RecsType.BigInt, start_time: RecsType.Number, sold: RecsType.BigInt, price_update_interval: RecsType.BigInt },
	      {
	        metadata: {
	          name: "LaborAuction",
	  ...
	  Movable: (() => {
	    return defineComponent(
	      world,
	      { entity_id: RecsType.BigInt, sec_per_km: RecsType.Number, blocked: RecsType.Boolean, round_trip: RecsType.Boolean, intermediate_coord_x: RecsType.Number, intermediate_coord_y: RecsType.Number },
	      {
	        metadata: {
	          name: "Movable",
	  ...
	  Road: (() => {
	    return defineComponent(
	      world,
	      { start_coord_x: RecsType.Number, start_coord_y: RecsType.Number, end_coord_x: RecsType.Number, end_coord_y: RecsType.Number, usage_count: RecsType.Number },
	      {
	        metadata: {
	          name: "Road",
	  ...
	  Trade: (() => {
	    return defineComponent(
	      world,
	      { trade_id: RecsType.BigInt, maker_id: RecsType.BigInt, maker_resource_chest_id: RecsType.BigInt, maker_transport_id: RecsType.BigInt, taker_id: RecsType.BigInt, taker_resource_chest_id: RecsType.BigInt, taker_transport_id: RecsType.BigInt, expires_at: RecsType.Number },
	      {
	        metadata: {
	          name: "Trade",
