...
const ChatForm = () => {
    ...
    return (
        <div className="flex items-center mt-auto bg-[#5E5E5E] bg-opacity-10 -m-2 p-2 border-t-[1px] border-white/20">
