  ...
  return (
    <SecondaryPopup name="explore">
      ...
      <SecondaryPopup.Body width={"410px"}>
        ...
        {step === 2 && (
          <div className="flex flex-col items-center p-2">
            <ExploreResultPanel foundResource={foundResource} onClose={onClose} />
          </div>
        )}
      </SecondaryPopup.Body>
    </SecondaryPopup>
...
const ExploreResultPanel = ({ foundResource, onClose }: ExploreResultPanelProps) => {
  let success = true;
      ...
      {success && (
        <>
          <div className="flex w-full items-center">
            ...
            <div className="text-[#86C16A] text-xs mx-2 flex-1 text-center">You found a chess!</div>
            <svg width="132" height="12" viewBox="0 0 132 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
              ...
              {foundResource && (
                <div className="flex justify-center items-center space-x-1 flex-wrap p-2 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                  ...
                  <div key={foundResource.resourceId} className="flex flex-col items-center justify-center">
                    <ResourceIcon size="md" resource={findResourceById(foundResource.resourceId)?.trait || ""} />
