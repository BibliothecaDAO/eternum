...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getOrders(variables?: GetOrdersQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetOrdersQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
    ...
    getTradeStatus(variables: GetTradeStatusQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetTradeStatusQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
    ...
    getCaravans(variables?: GetCaravansQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<{ data: GetCaravansQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
