...
SecondaryPopup.Body = ({ width = null, children }: { width?: string | null, children: React.ReactNode }) => <div className={`${width ? '' : 'w-[438px]'} relative z-10 bg-gray border flex flex-col border-white rounded-tr-[4px] rounded-b-[4px]`} style={{ width: width ? width : '' }}>
    {children}
</div>