...
export const directMessageThreads = pgTable(
  "direct_message_threads",
  {
    ...
    unreadCounts: jsonb("unread_counts").$type<Record<string, number>>(),
...
export const directMessageReadReceipts = pgTable(
...
export const directMessageTypingStates = pgTable(
  "direct_message_typing_states",
  {
    threadId: varchar("thread_id", { length: ENTITY_ID_MAX_LENGTH })
      .notNull()
      .references(() => directMessageThreads.id, {
