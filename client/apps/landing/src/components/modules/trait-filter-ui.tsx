...
export function TraitFilterUI({
  ...
  return (
    <div className=" my-2 p-4 border rounded-lg bg-muted/10">
      <div className="flex justify-between items-center mb-3">
        <Label className="text-lg uppercase">Filter by Trait</Label>
        {hasActiveFilters && (
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        {Object.entries(allTraits).map(([traitType, values]) => (
