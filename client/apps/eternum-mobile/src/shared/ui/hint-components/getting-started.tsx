...
export const GettingStarted = () => {
  const chapters = [
    ...
    },
    {
      ...
      content:
        "Deployed armies use stamina for movement on the map and for performing actions like attacking or exploring. Stamina regenerates partially each Eternum Day (e.g., +30). Different troop types have varying maximum stamina, and movement costs can differ by biome.",
    },
  ];
