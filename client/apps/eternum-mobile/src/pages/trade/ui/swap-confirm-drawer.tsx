    ...
    switch (state) {
        ...
        return (
          <div className="space-y-6">
            <div className="space-y-2">
              <h2 className="text-3xl font-bokor text-center">Confirm Swap</h2>
        ...
        return (
          <div className="space-y-6">
            <div className="space-y-4">
              <h2 className="text-3xl font-bokor text-center">Swapping</h2>
              <div className="space-y-4">
                <div className="flex items-center justify-center gap-2 text-xl">
      ...
      case "success":
        return (
          <div className="space-y-6">
            <div className="space-y-4">
              <h2 className="text-3xl font-bokor text-center text-green-500">Swap Successful</h2>
              <div className="space-y-4">
                <div className="flex items-center justify-center gap-2 text-xl">
                  <span className="text-red-500">-{sellAmount}</span>
                  <ResourceIcon resourceId={sellResource.id} size={24} />
      ...
      case "error":
        return (
          <div className="space-y-6">
            <div className="space-y-4">
              <h2 className="text-3xl font-bokor text-center text-red-500">Swap Failed</h2>
              <div className="space-y-4">
                <div className="flex items-center justify-center gap-2 text-xl">
