...
export const ProductionWidget = ({ building, resourceManager, realm }: LaborBuildingProps) => {
  ...
  const getBalance = useCallback(() => {
    return resourceManager.actualBalance(currentTick, building.produced.resource);
  ...
  useEffect(() => {
    ...
    const newBalance = resourceManager.actualBalance(realTick, building.produced.resource);
