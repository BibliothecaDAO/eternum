import { Message, MessageGroup } from "../model/types";

// Group messages by sender
export const groupMessagesBySender = (sortedMessages: Message[]): MessageGroup[] => {
  return sortedMessages.reduce((groups: Array<MessageGroup>, msg) => {
    ...
    if (!lastGroup || lastGroup.senderId !== msg.senderId || isNewTimeGroup || isShortMessage) {
      groups.push({
