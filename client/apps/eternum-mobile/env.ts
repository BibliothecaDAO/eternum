...
const envSchema = z.object({
  ...
  VITE_PUBLIC_CHAIN: z.enum(["sepolia", "mainnet", "local", "appchain"]), // Add other chains as needed
  VITE_PUBLIC_FORCE_GAME_MODE_ID: z.enum(["blitz", "eternum"]).optional().default("eternum"),
