...
[mini table for consistency, include Realm & Village production rates]
...
[big resource table with a column each for standard and simple mode - fix order and include Realm & Village production
rates]
...
[resource -> labor table - this needs to be divided into a Realm and Village column with input and output for each]
...
[troop table - include tiers and simple/standard mode]
