...
[screenshot of settling screen?]

Settled Realms start the game with the following starting materials: [table TBC]
...
[table TBC, include base no. armies, defensive army slots, and buildable hexes for each level]
