...
Each Village begins with a defensive army stationed as guard and an attacking army on the field. The specific type of
military unit is determined by your Realm's biome, and is strategically chosen to have a combat advantage in that
particular environment.

<StartingMilitary structureType={StructureType.Village} />
