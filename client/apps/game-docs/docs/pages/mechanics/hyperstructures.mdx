...
Eternum is achieved by accumulating
**{formatNumberWithCommas(ETERNUM_CONFIG().hyperstructures.hyperstructurePointsForWin)}** Victory Points. View and
manage Hyperstructures in the World Map under World Structures.
