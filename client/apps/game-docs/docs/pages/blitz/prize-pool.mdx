...
Every Blitz match in the Gladiator and Warrior brackets collects a $LORDS entry fee from each player.
...
winners and eligible for prize distribution. If there are less than 5
