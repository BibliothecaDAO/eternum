...
Every Blitz match in the Gladiator and Warrior brackets collects a $LORDS entry fee from each player. This fee is
allocated to support both player rewards and the ecosystem:

- **70%** forms the **prize pool** that gets distributed among winners
- **15%** fee is directed to the Realms ecosystem through the Lordship Protocol (veLORDS)
- **15%** is sent to the development fund to support ongoing operations of the core team

At the conclusion of each Blitz match, players are ranked by their final score. **Top-ranking Lords** are designated as
winners and eligible for prize distribution. If there are less than 5 players, the top ranked player is the sole winner.
...
receives a **refund of their $LORDS buy-in**, and the remainder of the prize pool is then distributed among winners
...
In addition to $LORDS prize pools, eligible players receive Loot Chest NFT rewards through an automated, decentralized
distribution system that mints rewards directly upon game completion. These chests contain cosmetic items and
consumables—see [Loot Chests](/overview/chests/loot-chests) for details.
