...
The Realms of each participating Lord are positioned three hexes apart in a triangle formation. Each Realm is also
located within eight hexes of a Hyperstructure and eight hexes from the nearest Realm belonging to another Lord
(assuming all available player positions are filled). More details of the positioning system are available in the
