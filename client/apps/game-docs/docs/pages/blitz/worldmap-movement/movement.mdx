...
the known boundaries of the world. If the newly explored hex contains a World Structure, the exploring
...
If an army doesn't have sufficient carrying capacity to store the discovered materials, the materials will be permanently lost (burned)
but the army will be able to continue exploring provided they have enough stamina. Armies can
