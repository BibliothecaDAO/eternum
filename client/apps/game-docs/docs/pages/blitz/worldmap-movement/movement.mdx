...
Troops also require Wheat to move. This is consumed from their home Realm when a movement order is executed. Each troop
consumes **0.1** Wheat to explore a tile, or **0.05** Wheat to traverse an already explored tile.
