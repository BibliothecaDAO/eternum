...
maximizing an army's effectiveness. Armies regenerate stamina at a consistent rate of +20 stamina per Phase (one minute), totaling +120 stamina per Eternum Day. Each
...
Troops can be transferred between armies (and Realm defense slots) at any time, and transfers are not impacted by battle 
