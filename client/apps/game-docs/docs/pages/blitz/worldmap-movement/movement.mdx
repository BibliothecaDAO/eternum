...
the known boundaries of the world. If the newly explored hex contains a world structure or an agent army, the exploring
army will automatically be pushed back to the hex from which they started without any additional stamina penalty.

During exploration, armies gather any valuables they encounter, receiving the goods directly into their inventory. The
reward chances for any explored hex are a _work in progress_.
