...
continued Realm expansion and troop production. Essence Rifts produce Essence at a rate of 1 unit per second. Lords have
a 2.5% chance of finding one of these structures when exploring a hex.
...
Lords have a 2.5% chance of finding one of these structures when exploring a hex.
