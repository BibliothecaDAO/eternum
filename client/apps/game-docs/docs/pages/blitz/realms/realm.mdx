...
Realms are settled at the start of the 30-minute 'Settling Phase' prior to the start of the game. Lords who are
...
_Note: The type of troop received depends on the biome that the realm is spawned on. Starting troops will always have a
