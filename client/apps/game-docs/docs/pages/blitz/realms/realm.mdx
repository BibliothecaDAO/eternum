...
Realms are settled during the 30-minute 'Settling Phase' prior to the start of the game. Lords who are registered to
play are drawn at random from the pool and assigned spawn positions sequentially according to the settling algorithm.
Once assigned a map position, Lords are required to confirm their participation in the session by initiating a 'Settle'
transaction, which will place their three Realms in their drawn position. This must be done in the 30-minute Settling
Phase to ensure presence and readiness to play the game. Lords who fail to confirm settling during this phase will not
have their Realms placed and will forfeit participation in the session. Their allocated spawn position will remain empty
throughout the game.
