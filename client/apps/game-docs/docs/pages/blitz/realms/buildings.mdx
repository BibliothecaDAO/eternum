...
Construct buildings by selecting one in the buildings menu and clicking on an empty buildable hex in the local view, or by clicking the 'Build' button when accessing the buildings menu from the world view (this will place the building on the next available hex). Buildings can be constructed on any buildable hex of a Realm,
