...
**Population** is the total population used to construct the current buildings on a Realm, while **population
...
<BlitzBuildingCard
  ...
  buildingType={2}
  description={["Increases storage capacity by 20,000 kg for each material"]}
  simpleCosts={[
    { resource: 23, amount: 1200 }, // Labor
  ]}
  standardCosts={[
