...
<BlitzBuildingCard
  ...
  resourceCosts={[
    ...
    { resource: ResourcesIds.Essence, amount: 500 }, // Essence
  ]}
  standardOnly={true}
/>
...
<BlitzBuildingCard
  ...
  simpleCosts={[
    { resource: 23, amount: 90 }, // Labor
  ]}
  standardCosts={[
    { resource: 23, amount: 30 }, // Labor
    { resource: 3, amount: 30 }, // Wood
  ]}
/>
...
<BlitzBuildingCard
  ...
  resourceCosts={[
    ...
    { resource: ResourcesIds.Essence, amount: 1000 }, // Essence
  ]}
/>
