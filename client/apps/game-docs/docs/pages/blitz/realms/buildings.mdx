...
Note: Some buildings only require food to construct. Farms and Resource Buildings have the same
...
is far more efficient overall. This building mode is generally designed for those with multiple Realms
...
Population is the total population utilised by the currently constructed production buildings on a Realm,
...
Settling any Realm will automatically construct a structure in the centre of your buildable hexes, known as
