...
materials in and out of the game (other than Relics, which can be bridged in prior to the start of the game - _WIP feature_). All
materials have an associated weight, which determines the number of Donkeys required to move the goods from place to place.
