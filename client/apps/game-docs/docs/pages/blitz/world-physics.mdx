...
specific pattern to ensure that all Lords have a comparable number of neighbors and equal access to Hyperstructures. More
detail on the Realm and Hyperstructure placement systems are available in the [Realms](/blitz/realms/realm) and 
