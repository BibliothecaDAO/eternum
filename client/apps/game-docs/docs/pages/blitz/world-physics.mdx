...
_Note: This guide will use 'materials' to refer to all tangible assets - i.e. food, resources, essence, labor,
troops, and donkeys. This is not to be confused with 'resources', which specifically refers to the 9 resources in
Blitz._

## Cost of Production

With the exception of food and labor, nothing in Blitz is produced for free; every unit of production demands an input—food,
