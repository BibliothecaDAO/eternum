...
Time within a Blitz game is measured in Eternum Days, and each is precisely one minute in length. One day ends and the
next begins every minute, so a single Blitz game takes place over 120 Eternum Days.
