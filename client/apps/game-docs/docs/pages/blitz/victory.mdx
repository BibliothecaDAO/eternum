...
_Note: VP for claiming World Structures and Hyperstructures are only rewarded the first time a structure is captured
(from bandit forces)._
...
<img
  src="/images/gifs/hyperstructure_ring_progression.gif"
  alt="Hyperstructure Ring Progression"
  ...
  <div style={table.wrapper}>
    <table style={table.table}>
      ...
      <tbody>
        ...
        <tr style={table.tableRow}>
          <td style={table.cell}>Open a Relic Crate</td>
          <td style={table.cell}>1,000 VP</td>
        </tr>
        <tr style={table.tableRow}>
          <td style={table.cell}>Claim a Hyperstructure from bandits</td>
          <td style={table.cell}>3,000 VP</td>
        </tr>
        <tr style={table.tableRow}>
