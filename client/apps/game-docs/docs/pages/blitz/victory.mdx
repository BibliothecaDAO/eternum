...
_Note: World Structure and Hyperstructure claim VP are only rewarded the first time a structure is captured (from bandit forces)._
    ...
    <table style={table.table}>
      ...
      <tbody>
        ...
        <tr style={table.tableRow}>
          ...
          <td style={table.cell}>2000 VP</td>
        </tr>
        <tr style={table.tableRow}>
          <td style={table.cell}>Control a Hyperstructure</td>
          <td style={table.cell}>5 VP/second</td>
        </tr>
      </tbody>
    </table>
  </div>
