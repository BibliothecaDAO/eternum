import { RealmDefenseSlotsTable, WorldStructureDefenseSlotsTable, BlitzWorldStructureDefenseSlotsTable } from "@/components/DefendingArmies";
...
**10 minutes**. Once all guard armies are defeated,
