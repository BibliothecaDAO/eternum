...
## Structure Guards and Claims

Structure guards defend Camps, Essence Rifts, Hyperstructures, and Realms from their guard slots. Crossbowman armies and
Crossbowman guards can use Combat v3 range-2 attacks to clear or threaten enemies from a distance, but a ranged attack
never claims a structure. Once guards are cleared, the claiming army must move adjacent and use an adjacent attack/claim
...
<div style={{ width: "100%", maxWidth: "100%" }}>
  ...
  >
    ...
    <tbody>
      ...
      <tr>
        <td style={{ padding: "0.6rem 1rem", textAlign: "left", color: "#ece0bd", fontSize: "0.85rem" }}>Empire</td>
        <td style={{ padding: "0.6rem 1rem", textAlign: "center", color: "#ece0bd", fontSize: "0.85rem" }}>90,000</td>
        <td style={{ padding: "0.6rem 1rem", textAlign: "center", color: "#ece0bd", fontSize: "0.85rem" }}>8</td>
        <td style={{ padding: "0.6rem 1rem", textAlign: "center", color: "#ece0bd", fontSize: "0.85rem" }}>4</td>
      </tr>
    </tbody>
  </table>
</div>
...
World Structures follow their structure-specific army slot limits:

- **Camps**: Use Settlement-level deployment caps, can create **1 field army**, and can maintain **1 guard slot**
- **Essence Rifts**: Use Settlement-level deployment caps and can maintain **1 guard slot**
- **Hyperstructures**: Use Empire-level deployment caps and can maintain **4 guard slots**

Essence Rifts and Hyperstructures are defensive-only structures for armies. Camps are the only discoverable world
structure that can create field armies.
