...
stamina value determined by its troop type and tier. Field armies expend stamina when moving,
...
The attacking army is the army initiating an instance of combat. Attacks require a minimum of **30 stamina**, so armies with less than 30 stamina cannot initiate an attack. Each
...
The defending army is the army being attacked in an instance of combat. Defending armies rely on having stamina available to maintain full combat effectiveness. When attacked, defending armies
...
the combat instance is started. Armies can gain either a combat advantage (**+30%** damage), disadvantage (**-30%** damage), or no
