...
The attacking army is the army initiating an instance of combat. To begin a combat round, the attacker must spend **50 stamina** 
(2.5 × stamina regen per phase). If the attacker does not have the full stamina cost, the attack command is rejected and no combat occurs.

### Defending Army

The defending army is the army being attacked in an instance of combat. The defender simultaneously spends **40 stamina** 
(2.0 × stamina regen per phase). If the defender's current stamina is below this required threshold, they receive a **30% damage penalty** 
