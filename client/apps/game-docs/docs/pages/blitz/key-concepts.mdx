...
- **Labor**: Produced automatically by each Realm, required for all construction and 'simple mode' production.
...
- **Movement & Stamina**: Armies move using stamina (regenerating at +30 per Eternum Day), with costs varying by biome
  and troop type.
...
Blitz uses Victory Points (VP) to determine leaderboard ranking. The players with the highest number of VP at the end 
of the two hours share in the $LORDS prize pool. This pool is made up of the cumulative entry fees that players pay to enter the game.
