...
- **Altered Rates**: All production rates are increased relative to production requirements for the fast-paced game format.
...
- **Movement & Stamina**: Armies move using stamina (regenerating at +60 per Eternum Day), with costs varying by biome and
  troop type.
