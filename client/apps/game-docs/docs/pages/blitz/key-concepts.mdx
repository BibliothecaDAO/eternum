...
Blitz uses Victory Points (VP) to determine leaderboard ranking. The players with the highest number of VP at the end of
the two hours share in the $LORDS prize pool. This pool is made up of the cumulative entry fees that players pay to
enter the game.
