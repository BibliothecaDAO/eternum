...
- **Stamina System**: Armies recover +30 stamina each Eternum Day.
...
Victory Points (VP) determine leaderboard ranking. The players with the highest number of VP at the end of
