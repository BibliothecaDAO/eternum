...
- **Production Types**:
  ...
  - **Troops**: Essential for exploration and warfare, with production of higher tier troops requiring lower tier troops as inputs.
...
Leaderboard placing is determined by total accumulated Victory Points, a measure of a Lord's ability to explore the map and control
World Structures. Victory Points are awarded for:
