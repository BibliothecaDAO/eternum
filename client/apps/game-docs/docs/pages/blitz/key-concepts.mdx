...
- **Biome Effects**: Each troop type has advantages (+30% damage), disadvantages (-30% damage), or no change (0%) in
  specific biomes.
- **Reinforcement Movement**: Troops can be transported by donkey to any player-owned Realms, Camps, Essence Rifts, or
  Hyperstructures, while transfers into armies still follow same-structure transfer rules.
