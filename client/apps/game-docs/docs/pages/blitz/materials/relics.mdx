...
[Relic Crates](/blitz/worldmap-movement/worldmap#relic-crates), or rewarded for playing Blitz games through
[Relic Chests](/overview/chests/contents#relic-chests). Depending on the nature of a relic, it can be consumed by an
army or a Realm in exchange for a time-limited bonus, such as a damage or production boost. When utilized at the right
time, these items can provide a strategic edge over your opponents.
