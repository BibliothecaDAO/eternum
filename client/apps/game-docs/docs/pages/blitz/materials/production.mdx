...
The rich and fertile lands produce staple food sources. Wheat is the primary food source in Blitz and can be produced without inputs, so once a Farm has been constructed, it can produce food indefinitely.

### Resources

The 9 resources found in Blitz are the backbone of the world economy. Producing one resource requires the input of
...
Labor is a mechanic that has been introduced to simplify and supplement gameplay. It is the primary
...
Labor is produced by permanently burning resources in the central structure of a Realm. This creates a steady
...
Blitz, three troop tiers are available, each requiring a combination of food, rare resources, and troops of
...
through production or purchase, to ensure that they can sustain their supply chains and logistics. Since donkeys are the 'gas' of this onchain world, they consume food during production.
