...
As is the case for building construction, Lords can choose between resource-based and labor-based production systems when deciding
...
_Note: Only T1 troops can be produced in both resource and labor mode. T2 and T3 troops can only be produced in
resource mode._
