...
Labor is a key component in the construction of all buildings and required for 'simple mode' production. In Blitz, it
is produced automatically in the Keep of each Realm.
