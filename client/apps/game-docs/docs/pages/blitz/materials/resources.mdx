...
Food is the cornerstone of a Realm's economy and is required in all production chains. Only wheat is available 
in Blitz and it can be produced without inputs.
...
Troops are required to defend your holdings and strike out at your foes. When produced, they can be transported
by donkey like any other material, but to be used they must be deployed to an army. Once deployed, they cannot be
converted back into material form.
...
Donkeys are essential for moving materials between your Realms. They only require a market and wheat to produce,
but are consumed after a single journey.
