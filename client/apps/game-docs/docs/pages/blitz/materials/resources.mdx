...
Food is the cornerstone of a Realm's economy:
...
This table uses hardcoded values instead of reading from config files. Replace with standard TroopsLimitTable component
once blitz configuration is complete. */}
