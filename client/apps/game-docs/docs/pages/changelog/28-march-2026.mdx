...
- Base output of all resources and essence increased to **2 units/sec** (up from 1 unit/sec).
- Labor production from the Keep increased to **2/sec** (up from 1/sec).
...
- Essence costs for constructing T2 and T3 military buildings have been **halved** (T2: 300 Essence, T3: 600 Essence).
