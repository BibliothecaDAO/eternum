...
Victory in Eternum is achieved by accumulating
**{formatNumberWithCommas(ETERNUM_CONFIG().hyperstructures.hyperstructurePointsForWin)}** Victory Points. While points
can only be earned through Hyperstructures, success requires various strategic activities:
