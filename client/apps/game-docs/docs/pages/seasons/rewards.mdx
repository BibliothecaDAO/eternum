...
Victory in Eternum is achieved by accumulating **{formatNumberWithCommas(ETERNUM_CONFIG().hyperstructures.hyperstructurePointsForWin)}** Victory
...
Any player who accumulates the required number of Victory Points can call the END_GAME contract, which disables all
...
By completing them, players will earn achievement points and compete for positions on the achievement leaderboard. At
