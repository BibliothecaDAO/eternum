...
| `--approve`               | Attempt automated browser approval                  |
| `--method=<type>`         | Auth method for auto-approve (e.g., `password`)     |
| `--username=<user>`       | Username for auto-approve                           |
| `--password=<pass>`       | Password for auto-approve                           |
