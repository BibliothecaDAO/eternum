...
**Relic Chest Discovery**: Each exploration also triggers a global check for **Relic Chest** discovery. If enough time has passed since the last chest was discovered globally, a new chest will spawn at a calculated distance from the exploration point. This creates exciting opportunities for explorers to trigger discoveries that benefit the entire game world.
