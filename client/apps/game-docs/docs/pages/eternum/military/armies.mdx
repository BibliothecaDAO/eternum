import { RealmDefenseSlotsTable, WorldStructureDefenseSlotsTable } from "@/components/eternum-components/DefendingArmies";
...
view. The maximum size of an army is **30,000**
