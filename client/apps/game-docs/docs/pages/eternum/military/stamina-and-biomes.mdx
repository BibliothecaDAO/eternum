...
The attacking army is the army initiating an instance of combat. To begin a combat round, the attacker must spend **5
...
(2 × stamina regen per phase). If the defender's current stamina is below this required threshold, they receive a **30%
damage penalty** during that combat round.
