...
<div style={{ 
  ...
  <p style={{ margin: 0 }}>By participating in Realms games, you fully acknowledge and accept the following terms and conditions.</p>
</div>
...
A season of Eternum concludes when a single player achieves the required **Victory Points** and clicks the "End Season" button. At this point:
...
Blitz game instances operate on a fixed schedule with immediate $LORDS prize distribution upon completion. Unlike Eternum
