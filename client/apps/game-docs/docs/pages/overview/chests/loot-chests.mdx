...
The secrets of the Loot Chests are now revealed and the secrets of their opening mechanism have been unlocked. Lords can
...
**Blitz Rewards Chest** - Success in Series 1 Blitz games will yield these chests (Warrior and Elite bracket only).
