...
**Blitz Rewards Chest (S0)** - Success in Series 0 Blitz games will yield these chests.

<div style={{ textAlign: "center" }}>
  <img
    src="/images/loot-chests/Chest- Blitz - v4.png"
    alt="Blitz Rewards Chest (Series 0)"
    style={{ width: "25%", height: "auto", display: "block", margin: "0 auto" }}
  />
</div>
