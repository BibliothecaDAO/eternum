---
title: Loot Chests
description: Understanding Loot Chest rewards from Realms games
---
...
The secrets of the Loot Chests are now revealed and their opening mechanisms have been unlocked. Lords can find more
detail on the contents of each Loot Chest type in the [Chest Contents](/overview/chests/contents) section, and open Loot
Chests on the [Loot Chest Collection Page](https://empire.realms.world/loot-chests).
...
**Blitz Rewards Chest** - Success in Series Blitz games (Warrior bracket) will yield these chests.
...
competition when used correctly. Players will be able to earn these through participation in any Blitz bracket and
through other yet-to-be-announced interactions in the ecosystem.
