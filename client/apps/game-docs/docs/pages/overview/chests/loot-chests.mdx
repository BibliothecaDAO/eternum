...
primarily rewarded for achievements and high-scoring gameplay and contain advantageous consumables or
flashy cosmetic items. In their sealed (unopened) form, they can be traded on 
the [Loot Chest Marketplace](https://empire.realms.world/trade/loot-chests).

The secrets of the Loot Chests are now revealed and the secrets of their opening mechanism have been unlocked. Lords
can find more detail on the contents of each Loot Chest type in the [Chest Contents](/overview/chests/contents) section,
and open Loot Chests in the [Loot Chest Vault](https://empire.realms.world/vault).
