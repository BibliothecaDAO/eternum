...
<div style={{ textAlign: "center" }}><img src="/images/resources/37.png" alt="LORDS Token" style={{ width: "120px", height: "auto", display: "inline-block" }} /></div>

$LORDS is the native token of the Realms. It serves as the primary currency within the ecosystem, enabling economic
activity and participation in various games.

## Token Details

- **Name**: LORDS
- **Network**: Ethereum Mainnet, Starknet
- **Contract Address**:
...
- **Blitz Entry Fees**: In Blitz, all entry fees in Gladiator and Warrior bracket games are converted to $LORDS before
  being added to the prize pool, which is distributed to top performers at the end of a game.
...
$LORDS can be purchased on decentralized exchanges on Starknet. [Ekubo](https://app.ekubo.org/?outputCurrency=LORDS&amount=1&inputCurrency=ETH) and [AVNU](https://app.avnu.fi/en/eth-lords) both support the Cartridge Controller, allowing Lords to swap directly with their game wallet.
