...
$LORDS is the native token of the Realms. It serves as the primary currency within the ecosystem,
...
- **Blitz Entry Fees**: In Blitz, all entry fees in Gladiator and Warrior bracket games are converted to $LORDS before being 
  added to the prize pool, which is distributed to top performers at the end of a game.
