...
$LORDS can be purchased on decentralized exchanges on Starknet.
[Ekubo](https://app.ekubo.org/?outputCurrency=LORDS&amount=1&inputCurrency=ETH) and
[AVNU](https://app.avnu.fi/en/eth-lords) both support the Cartridge Controller, allowing Lords to swap directly with
their game wallet.
