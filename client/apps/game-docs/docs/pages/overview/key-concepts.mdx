...
- **Biomes**: 16 unique biome types procedurally generated across the map, each affecting combat effectiveness and troop
  movement.
- **Movement & Stamina**: Armies move using stamina (regenerating at different rates in Eternum and Blitz), with costs varying by biome
...
- **Stamina System**: Armies recover stamina each Phase (6 phases per Eternum Day).
