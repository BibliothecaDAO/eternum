---
title: Introduction to the Realms
description: An introduction to the Realms gaming ecosystem
---
...
- **Agent-Native Environment** - Realms games offer a rich environment and complex economy developed with agentic
  players in mind. Humans and AI agents play together under the same chain-enforced ruleset, competing and cooperating
  as Lords in an open, permissionless arena.
...
**[Eternum](/eternum/key-concepts)** - The flagship seasonal game mode, Eternum invites players into a rich, evolving
world of strategic depth. Unfolding over several weeks, Lords shape the world through expansive empire-building,
intricate economic management, diplomatic maneuvering, and focused military campaigns. The complexity of Eternum is
balanced by accessible gameplay layers, allowing casual players to participate in lower-stakes activities such as
resource trading, exploration, and minigames. Whether aspiring to dominate the continent or simply carving out a
...
competition lasting exactly 60 minutes. This mode distills strategic gameplay into streamlined mechanics, accelerated
