  ...
  theme: {
    ...
    variables: {
      color: {
        ...
        title: "#f5ead0",
        noteBackground: "rgba(16, 20, 23, 0.88)",
        noteBorder: "rgba(231, 207, 136, 0.24)",
        noteText: "#cfc0a0",
        codeBlockBackground: "#080a0c",
        ...
        link: "#e7cf88",
        linkHover: "#f2dd9b",
        tableBorder: "rgba(231, 207, 136, 0.22)",
        tableHeaderBackground: "rgba(231, 207, 136, 0.1)",
        tableHeaderText: "#f2dd9b",
      },
    },
  },
  font: {
