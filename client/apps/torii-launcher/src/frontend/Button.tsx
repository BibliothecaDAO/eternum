...
const STYLES = {
  ...
  default: "bg-gold px-6 py-2 !text-brown",
  ...
  success:
    "border border-green !text-brilliance bg-transparent hover:bg-green/10",
...
const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      } ${isPulsing ? "animate-pulse" : ""} ${SIZES[size]} ${
    ...
    >
      {isLoading ? (
        <div
          className={`w-full inset-0 flex flex-col items-center justify-center h-full`}
        >
