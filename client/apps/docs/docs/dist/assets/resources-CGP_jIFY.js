import{j as e,d as h}from"./index-BXZ0OpAY.js";import{R as s,Z as m,l as u,d as j,b as c}from"./index-CeHJOaBa.js";import{R as n}from"./ResourceIcon-DVW_9hj1.js";import{a as d,b as l}from"./formatting-BVTaTn3x.js";const b=[{rarity:"Common (Widely Available)",resources:[{name:"Wood",id:s.Wood},{name:"Stone",id:s.Stone},{name:"Coal",id:s.Coal},{name:"Copper",id:s.Copper},{name:"Obsidian",id:s.Obsidian}]},{rarity:"Uncommon (Limited Availability)",resources:[{name:"Silver",id:s.Silver},{name:"Ironwood",id:s.Ironwood},{name:"Cold Iron",id:s.ColdIron},{name:"Gold",id:s.Gold}]},{rarity:"Rare (Scarce)",resources:[{name:"Hartwood",id:s.Hartwood},{name:"Diamonds",id:s.Diamonds},{name:"Sapphire",id:s.Sapphire},{name:"Ruby",id:s.Ruby}]},{rarity:"Unique (Very Scarce)",resources:[{name:"Deep Crystal",id:s.DeepCrystal},{name:"Ignium",id:s.Ignium},{name:"Ethereal Silica",id:s.EtherealSilica},{name:"True Ice",id:s.TrueIce},{name:"Twilight Quartz",id:s.TwilightQuartz},{name:"Alchemical Silver",id:s.AlchemicalSilver}]},{rarity:"Mythic (Extremely Rare)",resources:[{name:"Adamantine",id:s.Adamantine},{name:"Mithral",id:s.Mithral},{name:"Dragonhide",id:s.Dragonhide}]}],p=()=>e.jsx("div",{className:"overflow-x-auto",children:e.jsxs("table",{className:"min-w-full bg-gray",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{className:"py-2 px-4 border-b-2 border-gray-300 text-left",children:"Rarity"}),e.jsx("th",{className:"py-2 px-4 border-b-2 border-gray-300 text-left",children:"Resources"})]})}),e.jsx("tbody",{children:b.map(i=>e.jsxs("tr",{children:[e.jsx("td",{className:"py-2 px-4 border-b border-gray-300",children:i.rarity}),e.jsx("td",{className:"py-2 px-4 border-b border-gray-300",children:e.jsx("div",{className:"flex items-baseline gap-1",children:i.resources.map(r=>e.jsx(n,{name:r.name,id:r.id},r.id))})})]},i.rarity))})]})});function g(){const i=[s.Paladin,s.Knight,s.Crossbowman];return e.jsxs("div",{className:"my-4 p-4",children:[e.jsx("div",{className:"font-bold mb-6 text-xl",children:"Military Units"}),e.jsx("div",{className:"grid grid-cols-1 lg:grid-cols-3 gap-6",children:i.map(r=>{const a=m(r),x=u[r],t=j[r];return e.jsxs("div",{className:"border border-gray-700 p-4 rounded-lg bg-white/5",children:[e.jsxs("div",{className:"flex items-center gap-2 mb-4",children:[e.jsx(n,{size:"xl",id:r,name:(a==null?void 0:a.trait)||""}),e.jsx("span",{className:"text-md font-semibold truncate",children:(a==null?void 0:a.trait)||"Unknown"})]}),e.jsxs("div",{className:"mb-2 font-bold",children:["⚡️ Stamina: ",e.jsx("span",{className:"text-gray-400",children:x})]}),e.jsx("div",{className:"text-sm font-bold mb-2",children:"Food consumed / unit:"}),e.jsxs("div",{className:"grid grid-cols-3 gap-2",children:[e.jsxs("div",{className:"text-left",children:[e.jsx("div",{children:"Travel"}),e.jsx("div",{className:"text-gray-400",children:d(Number(l(t.travel_wheat_burn_amount)))}),e.jsx("div",{className:"text-gray-400",children:d(Number(l(t.travel_fish_burn_amount)))})]}),e.jsxs("div",{className:"text-left",children:[e.jsx("div",{children:"Explore"}),e.jsx("div",{className:"text-gray-400",children:d(Number(l(t.explore_wheat_burn_amount)))}),e.jsx("div",{className:"text-gray-400",children:d(Number(l(t.explore_fish_burn_amount)))})]}),e.jsxs("div",{className:"flex flex-col items-center mt-6",children:[e.jsx(n,{size:"lg",id:s.Wheat,name:"Wheat"}),e.jsx(n,{size:"lg",id:s.Fish,name:"Fish"})]})]}),e.jsx("div",{className:"border-t border-gray-500 my-4"}),e.jsx("div",{className:"text-sm font-bold mb-2",children:"Stamina Consumed:"}),e.jsxs("div",{className:"grid grid-cols-3 gap-2",children:[e.jsxs("div",{className:"text-left",children:[e.jsx("div",{children:"Travel"}),e.jsx("div",{className:"text-gray-400",children:d(c.stamina.travelCost)})]}),e.jsxs("div",{className:"text-left",children:[e.jsx("div",{children:"Explore"}),e.jsx("div",{className:"text-gray-400",children:d(c.stamina.exploreCost)})]}),e.jsx("div",{className:"flex justify-center items-center mt-4",children:e.jsx("div",{children:"⚡️"})})]})]},r)})})]})}const R={title:"Resources",description:"undefined"};function o(i){const r={a:"a",div:"div",h1:"h1",h2:"h2",h3:"h3",h4:"h4",header:"header",hr:"hr",li:"li",p:"p",strong:"strong",ul:"ul",...h(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(r.header,{children:e.jsxs(r.h1,{id:"resources",children:["Resources",e.jsx(r.a,{"aria-hidden":"true",tabIndex:"-1",href:"#resources",children:e.jsx(r.div,{"data-autolink-icon":!0})})]})}),`
...
`]})]})}function C(i={}){const{wrapper:r}={...h(),...i.components};return r?e.jsx(r,{...i,children:e.jsx(o,{...i})}):o(i)}export{C as default,R as frontmatter};
