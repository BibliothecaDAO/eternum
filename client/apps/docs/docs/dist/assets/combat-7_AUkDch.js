import{d as s,j as e}from"./index-BXZ0OpAY.js";import{b as r}from"./index-CeHJOaBa.js";const d=void 0;function a(i){const n={a:"a",blockquote:"blockquote",div:"div",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.h2,{id:"combat-system",children:["Combat System",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#combat-system",children:e.jsx(n.div,{"data-autolink-icon":!0})})]}),`
...
uneven matchups may resolve more quickly as the stronger force overwhelms their opponent. Battles can be simulated using
the in-game simulator to determine durations.`}),`
...
`,e.jsxs(n.p,{children:["When attacking a Realm or the Central Bank, combat begins with an ",r.battle.delaySeconds/3600,` hour
siege phase. During this time, defenders can:`]}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(n.li,{children:"Other armies can join a side"}),`
`]}),`
