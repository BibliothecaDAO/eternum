import{r as h,j as e,d as u}from"./index-BXZ0OpAY.js";import{F as a,R as x,Z as c,$ as m,b as p}from"./index-CeHJOaBa.js";import{R as d}from"./ResourceIcon-DVW_9hj1.js";function j(){const n=h.useMemo(()=>{const r=[];for(const s of Object.keys(a)){if(s===x.Lords)continue;const o={resource:c(Number(s)),amount:m[s],resource_type:s,cost:a[s].map(t=>{var i;return{...t,amount:t.amount*p.resources.resourcePrecision,name:((i=c(t.resource))==null?void 0:i.trait)||""}})};r.push(o)}return r},[]);return e.jsx("div",{className:"px-6 pt-6 mb-6 rounded-lg border border-gray-200 dark:border-gray-700 bg-white/5",children:e.jsxs("table",{className:"w-full border-separate border-gray-700 border-spacing-y-5",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{className:"border-b border-gray-500 text-left",children:"Resource"}),e.jsx("th",{className:"border-b border-gray-500 pb-2 text-center",children:"Production p/s"}),e.jsx("th",{className:"border-b border-gray-500 pb-2 text-left",children:"Cost p/s"})]})}),e.jsx("tbody",{children:n.map(r=>{var s,o,t;return e.jsxs("tr",{children:[e.jsx("td",{className:"border-b border-gray-500 py-4",children:e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx(d,{size:"xl",id:((s=r.resource)==null?void 0:s.id)||0,name:((o=r.resource)==null?void 0:o.trait)||""}),e.jsx("div",{className:"text-lg text-gray-400 dark:text-gray-300 font-medium",children:((t=r.resource)==null?void 0:t.trait)||"Unknown Resource"})]})}),e.jsx("td",{className:"text-center border-b border-gray-500",children:r.amount}),e.jsx("td",{className:"py-2 border-b border-gray-500",children:e.jsx("div",{className:"flex flex-col gap-4",children:r.cost.map(i=>e.jsx("div",{className:"p-3 rounded-lg border border-gray-500 bg-gray-800",children:e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(d,{size:"lg",id:i.resource,name:i.name||""}),e.jsxs("div",{children:[e.jsx("span",{className:"text-md",children:i.amount}),e.jsx("div",{className:"font-bold",children:i.name})]})]})},i.resource))})})]},r.resource_type)})})]})})}const y=void 0;function l(n){const r={a:"a",blockquote:"blockquote",br:"br",div:"div",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...u(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsxs(r.h2,{id:"production",children:["Production",e.jsx(r.a,{"aria-hidden":"true",tabIndex:"-1",href:"#production",children:e.jsx(r.div,{"data-autolink-icon":!0})})]}),`
