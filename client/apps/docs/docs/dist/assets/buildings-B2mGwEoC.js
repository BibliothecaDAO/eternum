import{j as e,d as b}from"./index-BXZ0OpAY.js";import{b as h,R as p,Q as t,Z as x,t as f,e as y}from"./index-CeHJOaBa.js";import{R as g}from"./ResourceIcon-DVW_9hj1.js";import{b as m}from"./formatting-BVTaTn3x.js";function v({buildingType:r}){const i=h.buildings.buildingCosts[r]||[],d=h.resources.resourceBuildingCosts[p.Wood]||[],c=h.resources.resourceBuildingCosts[p.Stone]||[];return r===t.Resource?e.jsxs("div",{className:"my-4 p-3",children:[e.jsx("div",{className:"font-bold mb-2",children:"Building costs:"}),e.jsxs("div",{className:"flex flex-row items-center gap-4",children:[d.map(n=>{const s=x(n.resource);return e.jsxs("div",{className:"flex items-center px-2 py-2 rounded-md",children:[e.jsx(g,{size:"lg",id:n.resource,name:(s==null?void 0:s.trait)||""}),e.jsxs("div",{className:"flex flex-col",children:[e.jsx("span",{children:s==null?void 0:s.trait}),e.jsx("span",{children:m(n.amount)})]})]},n.resource)}),e.jsx("span",{children:"or"}),c.map(n=>{const s=x(n.resource);return e.jsxs("div",{className:"flex items-center gap-1 px-2 py-1.5 rounded-md",children:[e.jsx(g,{size:"lg",id:n.resource,name:(s==null?void 0:s.trait)||""}),e.jsxs("div",{className:"flex flex-col",children:[e.jsx("span",{children:s==null?void 0:s.trait}),e.jsx("span",{children:m(n.amount)})]})]},n.resource)})]})]}):!i||i.length===0?null:e.jsxs("div",{className:"my-4 p-3",children:[e.jsx("div",{className:"font-bold mb-2",children:"Building costs:"}),e.jsx("div",{className:"grid grid-cols-2 gap-2",children:i.map(n=>{const s=x(n.resource);return e.jsxs("div",{className:"flex items-center gap-1 px-2 py-1.5 rounded-md",children:[e.jsx(g,{size:"lg",id:n.resource,name:(s==null?void 0:s.trait)||""}),e.jsxs("div",{className:"flex flex-col",children:[e.jsx("span",{className:"font-medium",children:s==null?void 0:s.trait}),e.jsx("span",{className:"font-medium",children:m(n.amount)})]})]},n.resource)})})]})}function a({title:r,image:i,buildingType:d,description:c,multipleImages:n}){const s=f[d]||0,o=y[d]||0;return e.jsxs("div",{className:"p-6 mb-6 rounded-lg border border-gray-700 bg-white/5",children:[e.jsx("div",{className:"text-xl font-bold mb-4",children:r}),n?e.jsx("div",{className:"grid grid-cols-3 mb-4",children:i.map((l,u)=>e.jsx("img",{src:l.src,alt:l.alt,width:"250"},u))}):e.jsx("img",{src:typeof i=="string"?i:"",alt:r,width:"250",className:"float-right"}),(s!==0||o!==0)&&e.jsxs("div",{className:"mt-2 text-md text-gray-300",children:[s!==0&&e.jsxs("div",{children:[e.jsx("strong",{children:"Population:"})," +",s]}),o!==0&&e.jsxs("div",{children:[e.jsx("strong",{children:"Population Capacity:"})," +",o]})]}),e.jsx(v,{buildingType:d}),e.jsx("ul",{className:"list-disc ml-4",children:c.map((l,u)=>e.jsx("li",{children:l},u))})]})}const k={title:"Buildings",description:"undefined"};function j(r){const i={a:"a",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...b(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(i.header,{children:e.jsxs(i.h1,{id:"buildings",children:["Buildings",e.jsx(i.a,{"aria-hidden":"true",tabIndex:"-1",href:"#buildings",children:e.jsx(i.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(a,{title:"Resource Facility",multipleImages:!0,image:[{src:"/buildings/forge.png",alt:"Forge"},{src:"/buildings/mine.png",alt:"Mine"},{src:"/buildings/lumber_mill.png",alt:"Lumber Mill"}],buildingType:t.Resource,description:["Produces specified resource","Consumes other resources"]}),`
...
`,e.jsx(i.p,{children:"Buildings can be paused/resumed: Pausing stops:"}),`
...
`]})]})}function I(r={}){const{wrapper:i}={...b(),...r.components};return i?e.jsx(i,{...r,children:e.jsx(j,{...r})}):j(r)}export{I as default,k as frontmatter};
