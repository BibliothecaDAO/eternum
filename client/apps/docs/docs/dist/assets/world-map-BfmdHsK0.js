import{d as t,j as e}from"./index-BXZ0OpAY.js";const s={title:"World Map",description:"Geography and exploration in Eternum"};function r(i){const n={a:"a",div:"div",h1:"h1",h2:"h2",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...t(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"-world-map",children:["🌎 World Map",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#-world-map",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`]})]})}function d(i={}){const{wrapper:n}={...t(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(r,{...i})}):r(i)}export{d as default,s as frontmatter};
