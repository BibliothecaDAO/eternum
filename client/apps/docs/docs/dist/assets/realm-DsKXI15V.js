import{j as e,d as c}from"./index-BXZ0OpAY.js";import{b as t,I as j,Z as h,W as g,J as p,c as l}from"./index-CeHJOaBa.js";import{R as u}from"./ResourceIcon-DVW_9hj1.js";import{c as b,b as m,f,d as v}from"./formatting-BVTaTn3x.js";function y(){return e.jsx("div",{className:"grid grid-cols-1 gap-6",children:Object.entries(t.questResources).map(([r,s])=>e.jsxs("div",{className:"p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white/5",children:[e.jsx("div",{className:"font-bold text-lg mb-4",children:b(j[Number(r)]||"Unknown Quest")}),e.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4",children:s.map((a,i)=>{const n=h(a.resource),x=(n==null?void 0:n.trait)||"Unknown Resource";return e.jsxs("div",{className:"flex items-center px-4 py-2 rounded-md bg-gray-800",children:[e.jsx(u,{size:"lg",id:a.resource,name:x}),e.jsx("span",{className:"font-medium text-gray-300 ml-4",children:m(a.amount)})]},i)})})]},r))})}function d({level:r,description:s}){const a=g[r]||[];return e.jsxs("div",{className:"p-6 mb-6 rounded-lg border border-gray-200 dark:border-gray-700 bg-white/5",children:[e.jsx("h4",{className:"text-lg font-bold mb-4",children:s}),a.length>0?e.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 gap-4",children:a.map(i=>{const n=h(i.resource);return e.jsxs("div",{className:"flex items-center gap-2  rounded-md ",children:[e.jsx(u,{size:"lg",id:i.resource,name:(n==null?void 0:n.trait)||""}),e.jsxs("div",{className:"flex flex-col",children:[e.jsx("span",{className:"font-medium",children:n==null?void 0:n.trait}),e.jsx("span",{className:"font-medium",children:m(i.amount)})]})]},i.resource)})}):e.jsx("p",{className:"text-white",children:"Your starting realm."})]})}const C={title:"Realms",description:"undefined"};function o(r){const s={a:"a",blockquote:"blockquote",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...c(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s.header,{children:e.jsxs(s.h1,{id:"realms",children:["Realms",e.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#realms",children:e.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(d,{level:l.Empire,description:"Empire - a vast empire with 60 buildable hexes"})]})}function I(r={}){const{wrapper:s}={...c(),...r.components};return s?e.jsx(s,{...r,children:e.jsx(o,{...r})}):o(r)}export{I as default,C as frontmatter};
