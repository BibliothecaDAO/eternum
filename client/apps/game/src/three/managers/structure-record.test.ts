...
describe("createStructureRecord", () => {
  it("builds a structure record with ownership and battle fields", () => {
    ...
    const record = createStructureRecord({
      ...
      activeArmyProduction: [{ resourceId: 26 as any, outputPerTick: 5n, outputAmountLeft: 50n, buildingCount: 3 }],
    ...
    expect(record).toEqual({
      ...
      activeArmyProduction: [{ resourceId: 26, outputPerTick: 5n, outputAmountLeft: 50n, buildingCount: 3 }],
