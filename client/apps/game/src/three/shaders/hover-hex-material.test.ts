...
describe("hover hex material factory", () => {
  it("creates an isolated shader-backed material with the expected control surface", () => {
  ...
  it("keeps the raw shader isolated to the dedicated factory", () => {
    ...
    expect(factorySource).toMatch(/new THREE\.ShaderMaterial\(/);
