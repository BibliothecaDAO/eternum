...
function createHumanoidDiagnostics(): ProceduralCharacterPoseDiagnostics {
  ...
  return {
    ...
    finite: true,
    feet: {
      left: { contact: "stance", position: [0, 0, 0] },
    ...
    joints,
    legs: {
      left: { kneeDegrees: 170, lowerLegLength: 0.5, upperLegLength: 0.5 },
      right: { kneeDegrees: 170, lowerLegLength: 0.5, upperLegLength: 0.5 },
    },
