...
export const MODEL_TYPE_TO_FILE: Record<ModelType, string> = {
  ...
  // [ModelType.Boat]: "knight",
  // [ModelType.Knight1]: "knight",
  // [ModelType.Knight2]: "knight",
  // [ModelType.Knight3]: "knight",
  // [ModelType.Crossbowman1]: "knight",
  // [ModelType.Crossbowman2]: "knight",
  // [ModelType.Crossbowman3]: "knight",
  // [ModelType.Paladin1]: "knight",
  // [ModelType.Paladin2]: "knight",
  // [ModelType.Paladin3]: "knight",
};
