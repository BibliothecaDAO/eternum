...
export const ConstructionGate = () => {
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden p-4 text-center text-gold">
      ...
      <div className="panel-wood relative z-10 flex w-full max-w-lg flex-col items-center justify-center rounded-xl border bg-brown p-6 sm:max-w-xl md:max-w-2xl md:p-10">
