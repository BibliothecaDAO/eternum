...
export const BUILDING_IMAGES_PATH = {
  ...
  [BuildingType.ResourceEarthenShard]:`${BUILD_IMAGES_PREFIX}mine.png`,
  [BuildingType.ResourceStone]:`${BUILD_IMAGES_PREFIX}mine.png`,
  [BuildingType.ResourceCoal]:`${BUILD_IMAGES_PREFIX}mine.png`,
  [BuildingType.ResourceWood]:`${BUILD_IMAGES_PREFIX}mine.png`,
  [BuildingType.ResourceCopper]:`${BUILD_IMAGES_PREFIX}mine.png`,
  [BuildingType.ResourceIronwood]:`${BUILD_IMAGES_PREFIX}mine.png`,
  [BuildingType.ResourceObsidian]:`${BUILD_IMAGES_PREFIX}mine.png`,
  [BuildingType.ResourceGold]:`${BUILD_IMAGES_PREFIX}mine.png`,
  [BuildingType.ResourceSilver]:`${BUILD_IMAGES_PREFIX}mine.png`,
  [BuildingType.ResourceMithral]:`${BUILD_IMAGES_PREFIX}mine.png`,
  [BuildingType.ResourceAlchemicalSilver]:`${BUILD_IMAGES_PREFIX}mine.png`,
  [BuildingType.ResourceColdIron]:`${BUILD_IMAGES_PREFIX}mine.png`,
  ...
  [BuildingType.ResourceHartwood]:`${BUILD_IMAGES_PREFIX}mine.png`,
  [BuildingType.ResourceIgnium]:`${BUILD_IMAGES_PREFIX}mine.png`,
  ...
  [BuildingType.ResourceAdamantine]:`${BUILD_IMAGES_PREFIX}mine.png`,
  ...
  [BuildingType.ResourceDragonhide]:`${BUILD_IMAGES_PREFIX}mine.png`,
