...
export const Combat = () => {
  ...
  return (
    <div>
      <div>
        <p>work in progress, this section will be updated soon</p>
      </div>
    </div>
  );
  //   const chapter = [
  ...
  //     {
  //       title: "Exploration",
  //       content: `An offensive army is crucial for exploration, engaging foes, and discovering treasures in Eternum. Your army's stamina fuels these expeditions. You can only have a certain number of attacking armies per Realm. You start at ${troopConfig.troop_limit_config.explorer_max_party_count} and get ${troopConfig.troop_limit_config.troops_per_military_building} per military building.`,
  //     },
  //     {
  //       title: "Battles",
  //       content: <Battles />,
