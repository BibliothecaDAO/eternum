...
enum BiomeFilenames {
  Bare = "bare.png",
  Beach = "beach.png",
  TemperateDeciduousForest = "deciduousForest.png",
...
export const BiomeInfoPanel = ({ biome, compact = false }: { biome: BiomeType; compact?: boolean }) => {
  return (
    <div
      className={`${compact ? "p-2" : "p-4"} border panel-wood rounded-lg backdrop-blur-sm shadow-inner relative overflow-hidden h-full`}
      style={{
    ...
    >
      ...
      >
        <div>
          <h2 className={`${compact ? "text-lg" : "text-2xl"} font-bold text-gold flex items-center gap-2`}>
            <span className="text-gold/70 text-sm">Terrain:</span> {biome}
          </h2>
          {!compact && (
        ...
        <div className={`flex flex-wrap gap-2 ${compact ? "mt-1" : "mt-2 sm:mt-0"}`}>
          ...
          >
            <div className="text-xs uppercase tracking-wider text-gold/50 mb-0.5">Melee</div>
          ...
          >
            <div className="text-xs uppercase tracking-wider text-gold/50 mb-0.5">Ranged</div>
            <div className={`${compact ? "text-base" : "text-lg"} font-bold`}>
          ...
          >
            <div className="text-xs uppercase tracking-wider text-gold/50 mb-0.5">Paladins</div>
            <div className={`${compact ? "text-base" : "text-lg"} font-bold`}>
