    ...
    <section className="animate-fade-in-up px-4 pt-4 md:px-0 md:pt-0">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between md:gap-6">
        <div className="max-w-3xl">
          ...
          <p className="mt-2 max-w-2xl text-[15px] leading-6 text-[#fbf4ea]/62 md:mt-3 md:text-sm">
            This version is built around two simple jobs: start a game, or check a game.
          </p>
        </div>

        <div className="grid w-full gap-2 sm:grid-cols-2 md:w-auto md:flex md:flex-wrap">
          <button
            type="button"
            onClick={onBack}
            className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium text-[#fbf4ea]/78 transition-colors hover:bg-white/10 hover:text-[#fbf4ea] md:w-auto"
          >
