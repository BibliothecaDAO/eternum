...
export const policies = toSessionPolicies({
	contracts: {
		[getContractByName(dojoConfig.manifest, "s1_eternum", "bank_systems")
			.address]: {
			methods: [
				{
					name: "create_banks",
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "config_systems")
			.address]: {
			methods: [
				{
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "guild_systems")
			.address]: {
			methods: [
				{
					name: "create_guild",
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "liquidity_systems")
			.address]: {
			methods: [
				{
					name: "add",
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "name_systems")
			.address]: {
			methods: [
				{
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "ownership_systems")
			.address]: {
			methods: [
				{
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "production_systems")
			.address]: {
			methods: [
				{
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "realm_systems")
			.address]: {
			methods: [
				{
					name: "create",
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "resource_systems")
			.address]: {
			methods: [
				{
					name: "deposit",
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "season_systems")
			.address]: {
			methods: [
				{
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "structure_systems")
			.address]: {
			methods: [
				{
					name: "level_up",
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "swap_systems")
			.address]: {
			methods: [
				{
					name: "buy",
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "trade_systems")
			.address]: {
			methods: [
				{
					name: "create_order",
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "troop_raid_systems")
			.address]: {
			methods: [
				{
		...
		[getContractByName(dojoConfig.manifest, "s1_eternum", "village_systems")
			.address]: {
			methods: [
				{
					name: "upgrade",
