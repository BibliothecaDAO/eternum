---
last_evaluated: tick-0
---

# Current Priorities

1. **Exploration** (HIGH) — Each explored tile awards Victory Points
2. **Economy** (HIGH) — Resource production enables all other activities
3. **Military** (LOW) — No known threats yet
4. **Expansion** (LOW) — Requires scouting data first

## Victory Points (VP) — How Scoring Works
