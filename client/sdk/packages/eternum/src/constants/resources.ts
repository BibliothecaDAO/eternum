...
export const RESOURCE_BUILDING_COSTS: ResourceInputs = {
  [ResourcesIds.Wood]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.Stone]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.Coal]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.Copper]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.Obsidian]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.Silver]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.Ironwood]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.ColdIron]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.Gold]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.Hartwood]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.Diamonds]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.Sapphire]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.Ruby]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.DeepCrystal]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.Ignium]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.EtherealSilica]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.TrueIce]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.TwilightQuartz]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.AlchemicalSilver]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.Adamantine]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.Mithral]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.Dragonhide]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.Donkey]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.Knight]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.Crossbowman]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.Paladin]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.Wheat]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.Fish]: [{ resource: ResourcesIds.Fish, amount: 0 }],
  [ResourcesIds.Lords]: [{ resource: ResourcesIds.Wheat, amount: 0 }],
  [ResourcesIds.AncientFragment]: [{ resource: ResourcesIds.Fish, amount: 0 }],
};
