...
export const SHARDS_MINES_WIN_PROBABILITY = 5; // 5/200 = 2.5%
export const SHARDS_MINES_FAIL_PROBABILITY = 195; // 195/200 = 97.5%
...
export const VILLAGE_FIND_PROBABILITY = 5; // 5/400 = 1.25%
export const VILLAGE_FIND_FAIL_PROBABILITY = 395; // 395/400 = 98.75%
