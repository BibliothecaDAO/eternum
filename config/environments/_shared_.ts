...
export const SHARDS_MINES_WIN_PROBABILITY = 5; // 5/100 = 5%
export const SHARDS_MINES_FAIL_PROBABILITY = 95; // 95/100 = 95%
...
export const VILLAGE_FIND_PROBABILITY = 5; // 5/100 = 5%
export const VILLAGE_FIND_FAIL_PROBABILITY = 95; // 95/100 = 95%
...
const BLITZ_REGISTRATION_PERIOD_SECONDS = 23 * ONE_HOUR_IN_SECONDS;
