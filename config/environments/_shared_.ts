...
export const QUEST_DISCOVERY_PROBABILITY = 5; // 5/100 = 5%
export const QUEST_DISCOVERY_FAIL_PROBABILITY = 95; // 95/100 = 95%
...
export const SEASON_POINT_REGISTRATION_CLOSE_AFTER_END_SECONDS = ONE_DAY_IN_SECONDS * 2; // 2 days
