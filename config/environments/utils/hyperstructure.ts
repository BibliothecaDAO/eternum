...
export const HYPERSTRUCTURE_POINTS_PER_CYCLE =
	7 * HYPERSTRUCTURE_POINT_MULTIPLIER;
export const HYPERSTRUCTURE_POINTS_FOR_WIN =
	9_620_000n * BigInt(HYPERSTRUCTURE_POINT_MULTIPLIER);
