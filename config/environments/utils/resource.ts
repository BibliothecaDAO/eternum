...
export const RESOURCE_PRODUCTION_INPUT_RESOURCES: ResourceInputs = {
  ...
  [ResourcesIds.KnightT2]: [
    ...
    { resource: ResourcesIds.Copper, amount: 0.48 },
    { resource: ResourcesIds.ColdIron, amount: 0.32 },
  ...
  [ResourcesIds.KnightT3]: [
    ...
    { resource: ResourcesIds.ColdIron, amount: 0.64 },
    { resource: ResourcesIds.Mithral, amount: 0.72 },
  ...
  [ResourcesIds.CrossbowmanT2]: [
    ...
    { resource: ResourcesIds.Copper, amount: 0.48 },
    { resource: ResourcesIds.Ironwood, amount: 0.32 },
    { resource: ResourcesIds.Essence, amount: 1 },
  ],
  [ResourcesIds.CrossbowmanT3]: [
    { resource: ResourcesIds.Wheat, amount: 7 },
    { resource: ResourcesIds.CrossbowmanT2, amount: 10 },
    { resource: ResourcesIds.Ironwood, amount: 0.64 },
    { resource: ResourcesIds.Adamantine, amount: 0.72 },
    { resource: ResourcesIds.Essence, amount: 3 },
  ],
  ...
  [ResourcesIds.PaladinT2]: [
    ...
    { resource: ResourcesIds.Copper, amount: 0.48 },
    { resource: ResourcesIds.Gold, amount: 0.32 },
    { resource: ResourcesIds.Essence, amount: 1 },
  ],
  [ResourcesIds.PaladinT3]: [
    { resource: ResourcesIds.Wheat, amount: 7 },
    { resource: ResourcesIds.PaladinT2, amount: 10 },
    { resource: ResourcesIds.Gold, amount: 0.64 },
    { resource: ResourcesIds.Dragonhide, amount: 0.72 },
    { resource: ResourcesIds.Essence, amount: 3 },
  ],
  [ResourcesIds.Wheat]: [],
  [ResourcesIds.Fish]: [],
