...
export const BUILDING_RESOURCE_PRODUCED: { [key in BuildingType]: number } = {
  [BuildingType.None]: getProducedResource(BuildingType.None),
  [BuildingType.WorkersHut]: getProducedResource(BuildingType.WorkersHut),
  [BuildingType.Storehouse]: getProducedResource(BuildingType.Storehouse),
  [BuildingType.ResourceStone]: getProducedResource(BuildingType.ResourceStone),
  [BuildingType.ResourceCoal]: getProducedResource(BuildingType.ResourceCoal),
  [BuildingType.ResourceWood]: getProducedResource(BuildingType.ResourceWood),
  [BuildingType.ResourceCopper]: getProducedResource(BuildingType.ResourceCopper),
  [BuildingType.ResourceIronwood]: getProducedResource(BuildingType.ResourceIronwood),
  [BuildingType.ResourceObsidian]: getProducedResource(BuildingType.ResourceObsidian),
  [BuildingType.ResourceGold]: getProducedResource(BuildingType.ResourceGold),
  [BuildingType.ResourceSilver]: getProducedResource(BuildingType.ResourceSilver),
  [BuildingType.ResourceMithral]: getProducedResource(BuildingType.ResourceMithral),
  [BuildingType.ResourceAlchemicalSilver]: getProducedResource(BuildingType.ResourceAlchemicalSilver),
  [BuildingType.ResourceColdIron]: getProducedResource(BuildingType.ResourceColdIron),
  [BuildingType.ResourceDeepCrystal]: getProducedResource(BuildingType.ResourceDeepCrystal),
  [BuildingType.ResourceRuby]: getProducedResource(BuildingType.ResourceRuby),
  [BuildingType.ResourceDiamonds]: getProducedResource(BuildingType.ResourceDiamonds),
  [BuildingType.ResourceHartwood]: getProducedResource(BuildingType.ResourceHartwood),
  [BuildingType.ResourceIgnium]: getProducedResource(BuildingType.ResourceIgnium),
  [BuildingType.ResourceTwilightQuartz]: getProducedResource(BuildingType.ResourceTwilightQuartz),
  [BuildingType.ResourceTrueIce]: getProducedResource(BuildingType.ResourceTrueIce),
  [BuildingType.ResourceAdamantine]: getProducedResource(BuildingType.ResourceAdamantine),
  [BuildingType.ResourceSapphire]: getProducedResource(BuildingType.ResourceSapphire),
  [BuildingType.ResourceEtherealSilica]: getProducedResource(BuildingType.ResourceEtherealSilica),
  [BuildingType.ResourceDragonhide]: getProducedResource(BuildingType.ResourceDragonhide),
  [BuildingType.ResourceLabor]: getProducedResource(BuildingType.ResourceLabor),
  [BuildingType.ResourceAncientFragment]: getProducedResource(BuildingType.ResourceAncientFragment),
  [BuildingType.ResourceDonkey]: getProducedResource(BuildingType.ResourceDonkey),
  [BuildingType.ResourceKnightT1]: getProducedResource(BuildingType.ResourceKnightT1),
  [BuildingType.ResourceKnightT2]: getProducedResource(BuildingType.ResourceKnightT2),
  [BuildingType.ResourceKnightT3]: getProducedResource(BuildingType.ResourceKnightT3),
  [BuildingType.ResourceCrossbowmanT1]: getProducedResource(BuildingType.ResourceCrossbowmanT1),
  [BuildingType.ResourceCrossbowmanT2]: getProducedResource(BuildingType.ResourceCrossbowmanT2),
  [BuildingType.ResourceCrossbowmanT3]: getProducedResource(BuildingType.ResourceCrossbowmanT3),
  [BuildingType.ResourcePaladinT1]: getProducedResource(BuildingType.ResourcePaladinT1),
  [BuildingType.ResourcePaladinT2]: getProducedResource(BuildingType.ResourcePaladinT2),
  [BuildingType.ResourcePaladinT3]: getProducedResource(BuildingType.ResourcePaladinT3),
  [BuildingType.ResourceWheat]: getProducedResource(BuildingType.ResourceWheat),
  [BuildingType.ResourceFish]: getProducedResource(BuildingType.ResourceFish),
};
...
export const BUILDING_COSTS: ResourceInputs = {
  ...
  [BuildingType.ResourceIgnium]: [{ resource: ResourcesIds.Wheat, amount: 750 }],
