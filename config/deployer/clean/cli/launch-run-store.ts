...
function usage(): void {
  console.log(
    [
      "",
      "Usage:",
      "  bun config/deployer/clean/cli/launch-run-store.ts --event <launch-started|step-started|step-succeeded|step-failed> --environment <slot.blitz|slot.eternum|mainnet.blitz|mainnet.eternum> --game <world-name> --start-time <unix|iso>",
      "",
      ...
      "",
      "Optional flags:",
      "  --launch-step <full|create-world|wait-for-factory-index|configure-world|grant-lootchest-role|grant-village-pass-role|create-banks|create-indexer|sync-paymaster>",
