...
function usage(): void {
  console.log(
    [
      "",
      "Usage:",
      "  bun config/deployer/clean/cli/launch-account-lease.ts --event <acquire|heartbeat|release> --environment <slot.blitz|slot.eternum|slottest.blitz|slottest.eternum|mainnet.blitz|mainnet.eternum> --game <world-name> --step <step-id>",
      "",
      "Required flags:",
