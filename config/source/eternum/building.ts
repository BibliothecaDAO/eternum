...
const BUILDING_RESOURCE_PRODUCED: Record<number, number> = {
...
const COMPLEX_BUILDING_COSTS: ResourceInputsById = {
  [BuildingType.None]: [],
...
const SIMPLE_BUILDING_COSTS: ResourceInputsById = {
  [BuildingType.None]: [],
  [BuildingType.ResourceLabor]: [],
  [BuildingType.ResourceAncientFragment]: [],
  // Basic Buildings
...
export const eternumBuildingConfig: ConfigPatch = {
  buildings: {
    ...
    buildingFixedCostScalePercent: 1_000,
  },
};
