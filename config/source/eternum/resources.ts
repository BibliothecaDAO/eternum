...
const LABOR_PRODUCTION_OUTPUT_AMOUNTS_THROUGH_RESOURCES: ResourceOutputsById = {
  ...
  [ResourcesIds.Stone]: 11,
  [ResourcesIds.Coal]: 12,
  [ResourcesIds.Copper]: 14,
  [ResourcesIds.Obsidian]: 15,
  [ResourcesIds.Silver]: 16,
  [ResourcesIds.Ironwood]: 16,
  [ResourcesIds.ColdIron]: 16,
  [ResourcesIds.Gold]: 16,
  [ResourcesIds.Hartwood]: 20,
  [ResourcesIds.Diamonds]: 20,
  [ResourcesIds.Sapphire]: 20,
  [ResourcesIds.Ruby]: 25,
  [ResourcesIds.DeepCrystal]: 25,
