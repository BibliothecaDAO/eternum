...
export const RESOURCE_PRODUCTION_OUTPUT_AMOUNTS: ResourceOutputsById = {
  [ResourcesIds.Wood]: 1,
...
export const RESOURCE_PRODUCTION_INPUT_RESOURCES: ResourceInputsById = {
  [ResourcesIds.Wood]: [
...
export const LABOR_PRODUCTION_OUTPUT_AMOUNTS_THROUGH_RESOURCES: ResourceOutputsById = {
  [ResourcesIds.Wood]: 0,
