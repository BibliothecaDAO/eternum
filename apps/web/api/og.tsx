  ...
  try {
    ...
    return new ImageResponse(
      ...
      >
        ...
        >
          <svg width="60" height="60" viewBox="0 0 24 24" fill="none" style={{ marginRight: 20 }}>
            <path
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            />
            <span style={{ color: "#a1a1aa", fontSize: 18 }}>Powered by $LORDS</span>
          </div>
          {path && <span style={{ color: "#6b7280", fontSize: 18 }}>realms.world{path}</span>}
        </div>
      </div>,
      {
        width: 1200,
