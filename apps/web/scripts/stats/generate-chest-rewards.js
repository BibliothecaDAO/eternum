...
async function generateChestRewards() {
  try {
    ...
    for (const stats of sortedStats) {
      ...
      console.log(
        `Points ${stats.range}: ${stats.playerCount} players × ${stats.chests} chests = ${totalChestsInBracket} total chests`,
      );
    }
    ...
    console.log(
      'Example: node generate-chest-rewards.js --brackets "950:1000:7,800:949:5,600:799:3,400:599:2,200:399:1,0:199:0"',
    );
    process.exit(1);
  }
}
