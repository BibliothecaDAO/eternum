...
export const Route = createFileRoute("/terms")({
  ...
  head: () => ({
    meta: generateMetaTags({
      ...
      description: "Terms of Service for Realms World — the rules governing your use of our onchain gaming ecosystem.",
      path: "/terms",
    }),
  }),
});
      ...
      <section className="relative py-24 sm:py-32">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="realm-title text-3xl sm:text-5xl mb-4">Terms of Service</h1>
            <p className="text-foreground/60 text-sm mb-12">Last updated: February 2025</p>
          </motion.div>
          ...
          >
            <div className="realm-panel rounded-lg border border-primary/15 p-6 sm:p-8 space-y-8">
              <Section title="1. Acceptance of Terms">
                <p>
                  By accessing or using Realms World (realms.world) and its associated services, games, and smart
                  contracts (collectively, the "Services"), you agree to be bound by these Terms of Service ("Terms").
                  The Services are operated by BibliothecaDAO and its contributors.
                </p>
              ...
              <Section title="2. Eligibility">
                <ul>
                  ...
                  <li>
                    You must not be located in, or a resident of, any jurisdiction where access to blockchain-based
                    services or digital assets is prohibited.
                  </li>
              ...
              <Section title="4. Blockchain Interactions">
                ...
                <p>
                  <strong>Gas Fees.</strong> Blockchain transactions require gas fees paid in the native token of the
                  network (e.g., ETH on Ethereum, STRK on Starknet). These fees are paid to network validators, not to
                  us.
                </p>
                <p>
                  <strong>Smart Contract Risk.</strong> The Services interact with smart contracts deployed on public
                  blockchains. While these contracts are open-source and auditable, they may contain bugs or
                  vulnerabilities. You interact with smart contracts at your own risk.
                </p>
                <p>
                  <strong>Wallet Security.</strong> You are responsible for maintaining the security of your wallet and
                  private keys. We never have access to your private keys and cannot recover lost funds.
                </p>
              </Section>
              ...
              <Section title="5. $LORDS Token and Digital Assets">
                ...
                <ul>
                  ...
                  <li>
                    You understand that we do not guarantee the value, liquidity, or transferability of any digital
                    asset.
                  </li>
                  <li>
                    You accept that game rewards, staking yields, and other incentives are subject to change based on
                    protocol mechanics and DAO governance.
                  </li>
                </ul>
              </Section>
              ...
              <Section title="6. Game Rules and Fair Play">
                ...
                <p>
                  AI agents used in games (e.g., Blitz) must operate within the parameters defined by each game's
                  protocol. Use of agents that circumvent game rules may result in disqualification.
                </p>
              </Section>

              <Section title="7. DAO Governance">
                <p>
                  BibliothecaDAO governs aspects of the Realms ecosystem through on-chain and off-chain voting.
                  Participation in governance is voluntary. Governance decisions are executed according to the DAO's
                  established processes and smart contract logic.
                </p>
              </Section>

              <Section title="8. Intellectual Property">
                <p>
                  The Realms World website design, branding, and original content are the property of BibliothecaDAO and
                  its contributors. Game source code is open-source and available under the respective licenses
                  published in each game's repository.
                </p>
                <p>
                  Loot, Realms, and related NFT assets are community-owned. Ownership of NFTs grants you rights as
                  defined by their respective smart contracts and community norms.
                </p>
              </Section>
              ...
              <Section title="9. Prohibited Conduct">
                ...
                <ul>
                  ...
                  <li>
                    Use automated systems to manipulate game outcomes or governance votes outside of permitted agent
                    frameworks
                  </li>
                </ul>
              </Section>
              ...
              <Section title="10. Disclaimers">
                ...
                <p>
                  WE ARE NOT RESPONSIBLE FOR ANY LOSSES ARISING FROM BLOCKCHAIN NETWORK FAILURES, SMART CONTRACT BUGS,
                  WALLET COMPROMISES, TOKEN PRICE FLUCTUATIONS, OR YOUR FAILURE TO SECURE YOUR PRIVATE KEYS.
                </p>
              </Section>

              <Section title="11. Limitation of Liability">
                <p>
                  TO THE MAXIMUM EXTENT PERMITTED BY LAW, BIBLIOTHECADAO AND ITS CONTRIBUTORS SHALL NOT BE LIABLE FOR
                  ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES ARISING FROM YOUR USE OF THE
                  SERVICES, INCLUDING BUT NOT LIMITED TO LOSS OF FUNDS, DATA, OR PROFITS.
                </p>
              </Section>

              <Section title="12. Indemnification">
                <p>
                  You agree to indemnify and hold harmless BibliothecaDAO and its contributors from any claims, damages,
                  losses, or expenses arising from your use of the Services or violation of these Terms.
                </p>
              </Section>
              ...
              <Section title="13. Modifications">
                <p>
                  ...
                  updating the "Last updated" date. Continued use of the Services after changes constitutes acceptance
