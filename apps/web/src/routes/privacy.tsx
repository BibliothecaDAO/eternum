...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: generateMetaTags({
      ...
      description: "Privacy policy for Realms World — how we handle your data across our onchain gaming ecosystem.",
      path: "/privacy",
    }),
  }),
});
      ...
      <section className="relative py-24 sm:py-32">
        <div className="container mx-auto px-4 max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <h1 className="realm-title text-3xl sm:text-5xl mb-4">Privacy Policy</h1>
          ...
          >
            <div className="realm-panel rounded-lg border border-primary/15 p-6 sm:p-8 space-y-8">
              <Section title="1. Introduction">
                ...
                <p>
                  Our Services interact with public blockchain networks (primarily Starknet and Ethereum). On-chain
                  transactions are public by design and are not covered by this policy.
                </p>
              </Section>

              <Section title="2. Information We Collect">
                <h4 className="text-foreground/90 font-semibold text-sm mt-4 mb-2">Information You Provide</h4>
                <ul>
                ...
                <h4 className="text-foreground/90 font-semibold text-sm mt-4 mb-2">Blockchain Data</h4>
                <p>
                  When you interact with on-chain games or contracts, your wallet address and transaction history are
                  recorded on the public blockchain. This data is inherently public and immutable. We may index and
                  display this data within our Services.
                </p>
              </Section>
              ...
              <Section title="4. Information Sharing">
                ...
                <ul>
                  <li>
                    <strong>Service Providers:</strong> Third-party analytics and infrastructure providers that help us
              ...
              <Section title="6. Data Retention">
                <p>
                  We retain collected information for as long as necessary to provide our Services and fulfill the
                  purposes described in this policy. On-chain data is permanent and cannot be deleted due to the
              ...
              <Section title="7. Security">
                <p>
                  ...
                  control. However, no system is perfectly secure. We cannot guarantee the absolute security of your
                  information.
                </p>
              </Section>
              ...
              <Section title="8. Your Rights">
                ...
                <p>
                  Note that on-chain data cannot be modified or deleted due to blockchain immutability. To exercise your
                  rights regarding off-chain data, contact us via Discord.
                </p>
              </Section>

              <Section title="9. Cookies and Tracking">
                <p>
                  We use minimal cookies and local storage necessary for the functioning of our Services, including:
                </p>
                <ul>
              ...
              <Section title="11. Changes to This Policy">
                <p>
                  ...
                  updating the "Last updated" date and posting the revised policy on this page.
                </p>
              </Section>
