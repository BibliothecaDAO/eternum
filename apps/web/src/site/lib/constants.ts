...
export const CONTRACTS = {
  ...
  STARKNET: {
    VELORDS: "0x047230028629128ac5bfbb384d32f925e70e329b624fc5d82e9c60f5746795cd" as `0x${string}`, // Replace with actual veLORDS contract address
    REWARD_POOL: "0x0091b13b83e5c34112aa066a844d4cbe6af99b3d134293829ca1730ea4869a71" as `0x${string}`, // Replace with actual RewardPool contract address
    LORDS_TOKEN: "0x0124aeb495b947201f5fac96fd1138e326ad86195b98df6dec9009158a533b49" as `0x${string}`,
