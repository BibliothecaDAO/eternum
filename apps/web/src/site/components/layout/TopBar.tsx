...
export function TopBar() {
  ...
  const pageSections = useMemo(() => (location.pathname === "/" ? homeSections : []), [location.pathname]);
  const railSections = pageSections;

  const scheduleActiveSection = useCallback((nextSection: string, immediate = false) => {
        ...
        <div className="py-3.5 sm:py-4">
          <div className="container mx-auto px-3 sm:px-4">
            <div className="relative flex items-center justify-between gap-2 sm:gap-4">
              ...
              >
                <img src="/rw-logo.svg" alt="Realms.World" className="w-11 sm:w-13" />
              </button>
              ...
              <nav className="absolute left-1/2 hidden -translate-x-1/2 items-center justify-center gap-5 lg:flex xl:gap-7">
                <Link
                  ...
                  className={cn(
                    ...
                    location.pathname === "/" ? "realm-nav-link-active text-primary" : "text-foreground/75",
                  )}
                >
                  Home
                </Link>
              ...
              <div className="flex items-center justify-end gap-2 sm:gap-3">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="rune" size="sm" className="lg:hidden px-2" aria-label="Open navigation menu">
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    isRailExpanded ? "max-w-[11rem] opacity-100 ml-2" : "max-w-0 opacity-0 ml-0",
                  )}
                >
                  {section.label}
                </span>
