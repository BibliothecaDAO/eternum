...
export function HexExplorerSection() {
  ...
  const [activeFeature, setActiveFeature] = useState<FeatureHexData | null>(null);
  ...
  // ── Callbacks ─────────────────────────────────────────────────────
  const handleFeatureActivate = useCallback((feature: FeatureHexData | null) => {
    setActiveFeature(feature);
  }, []);

  const handleAgentNearby = useCallback((agent: AgentData | null, screenPos: PixelCoord | null) => {
