...
export const SUPPORTED_L1_CHAIN_ID = env.VITE_PUBLIC_CHAIN == "sepolia" ? ChainId.SEPOLIA : ChainId.MAINNET;

export const SUPPORTED_L2_CHAIN_ID = SUPPORTED_L1_CHAIN_ID === ChainId.SEPOLIA ? ChainId.SN_SEPOLIA : ChainId.SN_MAIN;
...
export function formatNumber(amount: number | null | undefined, maximumFractionDigits = 2) {
