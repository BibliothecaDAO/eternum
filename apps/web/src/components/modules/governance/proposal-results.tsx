...
export const ProposalResults = ({ proposal }: { proposal: Proposal }) => {
  return (
    <div className="flex flex-col flex-wrap gap-2">
      <Badge variant="outline" className="flex justify-between border-success bg-success/10 py-2 hover:bg-success/20">
      ...
      <Badge variant="outline" className="flex justify-between border-muted-foreground bg-muted/20 py-2 hover:bg-muted">
        <span className="flex items-center">
