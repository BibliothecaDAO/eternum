  ...
  useEffect(() => {
    const fetchMarketplaceData = async () => {
      try {
        ...
        const response = await fetch("/stats/data/marketplace-sales.json");
        if (!response.ok) {
  ...
  const calculateStats = () => {
    ...
    const scenarios = [
      ...
      },
      {
        ...
        explanation:
          "Maximum theoretical value if all 8,000 Realms NFTs (Ethereum + Starknet) had received season passes",
      },
    ];
      ...
      <div className="season-pass-analysis">
          ...
          <div className="header-stats">
            ...
            <div className="stat-card secondary">
              ...
              <div className="stat-subtitle">
                {((REALMS_BRIDGED_TO_STARKNET / TOTAL_REALMS_NFTS) * 100).toFixed(1)}% of total
              </div>
            </div>
            ...
            <div className="stat-card secondary">
              ...
              <div className="stat-subtitle">
                {((SEASON_PASSES_MINTED / REALMS_BRIDGED_TO_STARKNET) * 100).toFixed(1)}% of bridged
              </div>
            </div>
            ...
            <div className="stat-card secondary">
              ...
              <div className="stat-subtitle">
                {((SEASON_PASSES_USED / SEASON_PASSES_MINTED) * 100).toFixed(1)}% of minted
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="scenarios-section">
          ...
          <p className="scenarios-intro">
            All season passes were provided <strong>free</strong> to Realms NFT holders. Here are different scenarios to
            estimate the total value created for Realms NFT holders using the average price of the marketplace sales:
          </p>
