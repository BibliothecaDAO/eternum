...
export type StatsPage = "revenue" | "rewards" | "season-pass";
...
export function StatsShell({ page, rewardTab }: StatsShellProps): React.JSX.Element {
    ...
    <div className="stats-page">
      <div className="App">
        ...
        <div className="tab-navigation">
          <Link
            to="/stats/revenue"
            className={`tab-button ${page === "revenue" ? "active" : ""}`}
            aria-label="View revenue analytics"
          >
            <span className="tab-text">Revenue</span>
          </Link>
          <Link
            to="/stats/season-pass"
            className={`tab-button ${page === "season-pass" ? "active" : ""}`}
          ...
          <Link
            to="/stats/rewards"
            className={`tab-button ${page === "rewards" ? "active" : ""}`}
        ...
        <div className="tab-content">
          {page === "revenue" && (
            <RevenuePage revenueData={revenueData} lordsPrice={lordsPrice} totalLords={totalLords} />
          )}
          {page === "rewards" && <RewardsPage lordsPrice={lordsPrice} strkPrice={strkPrice} tab={rewardTab} />}
          {page === "season-pass" && <SeasonPassPage lordsPrice={lordsPrice} />}
        </div>
        <Analytics />
      </div>
    </div>
