...
const EnvironmentSchema = Schema.Struct({
  ...
  NATIVE_ACCOUNT_ADDRESS: NonEmptyString,
  NATIVE_PRIVATE_KEY: NonEmptyString,
    ...
    Effect.flatMap((raw) =>
      Effect.try(() => {
        ...
        return {
          ...
          accountAddress: normalizeAddress(raw.NATIVE_ACCOUNT_ADDRESS),
          privateKey: raw.NATIVE_PRIVATE_KEY,
