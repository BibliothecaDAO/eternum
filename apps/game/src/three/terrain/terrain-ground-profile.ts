...
const BIOME_GROUND_RECIPES: Readonly<Record<BiomeType, TerrainGroundWeights>> = Object.freeze({
  ...
  [BiomeType.Bare]: weights(0, 0.44, 0.02, 0, 0, 0.54, 0, 0),
  [BiomeType.Tundra]: weights(0, 0.04, 0.04, 0.34, 0.08, 0.38, 0.12, 0),
  [BiomeType.Snow]: weights(0, 0, 0.02, 0, 0, 0.24, 0.74, 0),
  [BiomeType.TemperateDesert]: weights(0.02, 0.52, 0, 0, 0, 0.46, 0, 0),
  [BiomeType.Shrubland]: weights(0, 0.4, 0.12, 0.16, 0, 0.32, 0, 0),
  [BiomeType.Taiga]: weights(0, 0, 0.08, 0.06, 0.56, 0.12, 0.18, 0),
  [BiomeType.Grassland]: weights(0, 0.06, 0.36, 0.46, 0.08, 0.04, 0, 0),
  [BiomeType.TemperateDeciduousForest]: weights(0, 0, 0.55, 0.1, 0.3, 0.05, 0, 0),
  [BiomeType.TemperateRainForest]: weights(0, 0, 0.33, 0.6, 0.03, 0.04, 0, 0),
  [BiomeType.SubtropicalDesert]: weights(0.9, 0.04, 0, 0, 0, 0.06, 0, 0),
  [BiomeType.TropicalSeasonalForest]: weights(0, 0.44, 0.15, 0.08, 0.33, 0, 0, 0),
  [BiomeType.TropicalRainForest]: weights(0, 0, 0.55, 0.1, 0.3, 0.05, 0, 0),
});
...
export function resolveTerrainGroundEcology(
  ...
  const disturbance = clampUnit(vegetation.disturbanceStrength);
  ...
  return {
    ...
    tint: [
      clamp(
        0.78,
        1.12,
        1 - moss * 0.12 - regeneratingCover * 0.04 - wetlandCover * 0.1 + dryLitter * 0.06 + disturbance * 0.04,
      ),
      clamp(0.78, 1.12, 1 - moss * 0.04 + regeneratingCover * 0.04 - wetlandCover * 0.04 - disturbance * 0.025),
      clamp(
        0.78,
        1.12,
        1 - moss * 0.16 - regeneratingCover * 0.07 - wetlandCover * 0.08 - dryLitter * 0.1 - disturbance * 0.08,
      ),
    ],
