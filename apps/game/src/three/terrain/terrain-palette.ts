...
export const TERRAIN_BIOME_DESCRIPTORS: Readonly<Record<BiomeType, TerrainBiomeDescriptor>> = Object.freeze({
  ...
  [BiomeType.Taiga]: descriptor("Taiga", "#617e70", "#3e594f", 0.11, 0.17, 0.038, 0.98, 0.72, 0.3, 0.2, 0),
  [BiomeType.Grassland]: descriptor("Grassland", "#8ca961", "#586f40", 0.055, 0.1, 0.025, 1, 0.32, 0.08, 0, 0),
