...
export default class InstancedModel {
  ...
  private readonly goldGlow: LocalEmissiveGlow[] = [];
  ...
  public dispose(): void {
    ...
    this.goldGlow.forEach((glow) => glow.dispose());
    this.goldGlow.length = 0;
  ...
  private shouldAnimate(context?: AnimationVisibilityContext): boolean {
    ...
    // Use the shared visibility snapshot for this frame.
