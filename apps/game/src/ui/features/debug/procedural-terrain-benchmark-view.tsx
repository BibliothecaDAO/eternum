...
function createEmptySnapshot(
  ...
  return {
    ...
    chunks: {
      ...
      commitSamples: 0,
      convergedWindows: 0,
      firstCompletePageMaxMs: 0,
      firstCompletePageP95Ms: 0,
      firstCompletePageSamples: 0,
      firstRenderedFrameMaxMs: 0,
      firstRenderedFrameP95Ms: 0,
      firstRenderedFrameSamples: 0,
      ...
      staleWindows: 0,
      windowConvergenceMaxMs: 0,
      windowConvergenceP95Ms: 0,
      windowConvergenceSamples: 0,
      workerBuildMaxMs: 0,
      workerBuildP95Ms: 0,
      workerBuildSamples: 0,
    },
