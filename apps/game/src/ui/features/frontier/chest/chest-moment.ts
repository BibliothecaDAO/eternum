...
/** The player tapped a closed chest: the hold starts and lasts until the result arrives, hiding the transaction. */
export const beginChestOpening = (at: { x: number; y: number }, now = performance.now()): void => {
