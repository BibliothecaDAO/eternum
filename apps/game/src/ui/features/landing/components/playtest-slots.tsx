...
import { fetchPlaytestSlots, registerPlaytestSlot, type PlaytestSlot } from "../../factory-v2/api/factory-worker";
          ...
          >
            <div>
              ...
              {registration?.gameNumber != null && (
                <p role="status">
                  Assigned to {slot.name}-{registration.gameNumber}. Enter from your games below when settlement is
                  ready.
                </p>
              )}
