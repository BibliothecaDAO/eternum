      ...
      <div className="space-y-3">
        ...
        {developerConfig.isVersionCustomized ? (
          <div className="rounded-[18px] border border-amber-500/24 bg-amber-500/8 px-3 py-2.5">
            <p className="text-[12px] leading-5 text-amber-400/84">This version differs from the default for {mode}.</p>
          </div>
        ) : null}
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="text-[11px] leading-5 text-gold/42">
            {!developerConfig.account ? "Connect your wallet to send factory setters." : "Uses your gameplay account."}
          </span>
        </div>
