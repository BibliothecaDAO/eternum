...
const buildFactoryState = (overrides: Record<string, unknown> = {}) => ({
  ...
  biomeClimateOptions: {
    draft: {},
    errors: {},
    targets: [{ id: "game", label: "etrn-sunrise-01" }],
  ...
  setBiomeClimateValue: vi.fn(),
  randomizeSelectedBiomeClimateSeeds: vi.fn(),
  resetSelectedBiomeClimate: vi.fn(),
  applySelectedBiomeClimateToAll: vi.fn(),
