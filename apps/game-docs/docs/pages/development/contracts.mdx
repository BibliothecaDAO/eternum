...
Always use generate trait where possible to minimize code.
...
- use of `super::IBuildingContract` to minimize imports and make it clear where the interface is defined.
