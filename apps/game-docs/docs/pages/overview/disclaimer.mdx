...
Distribution of Loot Chest NFT rewards is handled through an automated, decentralized distribution system that mints
rewards directly to eligible players upon game completion.
