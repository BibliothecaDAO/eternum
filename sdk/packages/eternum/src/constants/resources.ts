...
export const RESOURCE_INPUTS: ResourceInputs = {
  ...
  [ResourcesIds.Dragonhide]: [
    ...
    { resource: ResourcesIds.Wood, amount: 4361 },
  ],
  [ResourcesIds.Donkey]: [{ resource: ResourcesIds.Wheat, amount: 2.5 }],
  [ResourcesIds.Knight]: [
...
export const BUILDING_COSTS: ResourceInputs = {
  ...
  [BuildingType.Resource]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [BuildingType.Farm]: [{ resource: ResourcesIds.Wheat, amount: 900 }],
  [BuildingType.FishingVillage]: [{ resource: ResourcesIds.Wheat, amount: 900 }],
  [BuildingType.Barracks]: [{ resource: ResourcesIds.Wheat, amount: 2000 }],
  [BuildingType.Market]: [{ resource: ResourcesIds.Wheat, amount: 1500 }],
  [BuildingType.ArcheryRange]: [{ resource: ResourcesIds.Wheat, amount: 2000 }],
  [BuildingType.Stable]: [{ resource: ResourcesIds.Wheat, amount: 2000 }],
  ...
  [BuildingType.WorkersHut]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [BuildingType.WatchTower]: [{ resource: ResourcesIds.Wheat, amount: 2000 }],
  [BuildingType.Walls]: [{ resource: ResourcesIds.Wheat, amount: 3000 }],
  [BuildingType.Storehouse]: [{ resource: ResourcesIds.Wheat, amount: 2000 }],
};

export const RESOURCE_BUILDING_COSTS: ResourceInputs = {
  [ResourcesIds.Wood]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Stone]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Coal]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Copper]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Obsidian]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Silver]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Ironwood]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.ColdIron]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Gold]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Hartwood]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Diamonds]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Sapphire]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Ruby]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.DeepCrystal]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Ignium]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.EtherealSilica]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.TrueIce]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.TwilightQuartz]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.AlchemicalSilver]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Adamantine]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Mithral]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Dragonhide]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Donkey]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Knight]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Crossbowmen]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Paladin]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Wheat]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Fish]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Lords]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
  [ResourcesIds.Earthenshard]: [{ resource: ResourcesIds.Wheat, amount: 500 }],
};
