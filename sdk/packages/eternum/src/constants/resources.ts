...
export const RESOURCE_OUTPUTS: ResourceOutputs = {
  ...
  [ResourcesIds.Stone]: 50,
  [ResourcesIds.Coal]: 50,
  [ResourcesIds.Copper]: 50,
  [ResourcesIds.Obsidian]: 50,
  [ResourcesIds.Silver]: 50,
  [ResourcesIds.Ironwood]: 50,
  [ResourcesIds.ColdIron]: 50,
  [ResourcesIds.Gold]: 50,
  [ResourcesIds.Hartwood]: 50,
  [ResourcesIds.Diamonds]: 50,
  [ResourcesIds.Sapphire]: 50,
  [ResourcesIds.Ruby]: 50,
  [ResourcesIds.DeepCrystal]: 50,
  [ResourcesIds.Ignium]: 50,
  [ResourcesIds.EtherealSilica]: 50,
  [ResourcesIds.TrueIce]: 50,
  [ResourcesIds.TwilightQuartz]: 50,
  [ResourcesIds.AlchemicalSilver]: 50,
