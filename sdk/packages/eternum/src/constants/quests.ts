...
export const QUEST_RESOURCES: { [key in QuestType]: ResourceCost[] } = {
  ...
  [QuestType.BuildResource]: [{ resource: ResourcesIds.Donkey, amount: 1 }],
  ...
  [QuestType.Travel]: [{ resource: ResourcesIds.Donkey, amount: 0.3 }],
  [QuestType.CreateTrade]: [
    { resource: ResourcesIds.Donkey, amount: 2 },
