        ...
        <div className="flex flex-col gap-2">
          <div className="grid grid-cols-[auto_1fr_auto_auto_auto_auto_auto_auto] items-center p-2 border-b border-gold/15 gap-x-8">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  <div className="font-medium truncate text-left hover:text-gold/80 transition-colors w-full">
                    Player
                  </div>
                </TooltipTrigger>
                <TooltipContent>
        ...
        {totalPages > 1 && (
          <div className="flex flex-col items-center gap-2 mt-4">
            ...
            <span className="text-sm text-gold/70 hover:text-gold transition-colors">
              {startIndex + 1}-{Math.min(startIndex + playersPerPage, filteredPlayers.length)} of{" "}
