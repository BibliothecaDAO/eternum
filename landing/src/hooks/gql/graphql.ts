...
export type Eternum_HasClaimedStartingResourcesOrder = {
  direction: OrderDirection;
  field: Eternum_HasClaimedStartingResourcesOrderField;
};

export enum Eternum_HasClaimedStartingResourcesOrderField {
  Claimed = "CLAIMED",
  ConfigId = "CONFIG_ID",
  EntityId = "ENTITY_ID",
}

export type Eternum_HasClaimedStartingResourcesWhereInput = {
...
export type Eternum_RealmFreeMintConfigOrder = {
  direction: OrderDirection;
  field: Eternum_RealmFreeMintConfigOrderField;
};

export enum Eternum_RealmFreeMintConfigOrderField {
  ConfigId = "CONFIG_ID",
  DetachedResourceCount = "DETACHED_RESOURCE_COUNT",
  DetachedResourceId = "DETACHED_RESOURCE_ID",
}

export type Eternum_RealmFreeMintConfigWhereInput = {
  config_id?: InputMaybe<Scalars["u32"]["input"]>;
  config_idEQ?: InputMaybe<Scalars["u32"]["input"]>;
  config_idGT?: InputMaybe<Scalars["u32"]["input"]>;
  config_idGTE?: InputMaybe<Scalars["u32"]["input"]>;
...
export type TotalPlayersQuery = {
  __typename?: "World__Query";
  eternumOwnerModels?: { __typename?: "eternum_OwnerConnection"; totalCount: number } | null;
};
